...
As well as delivering to out-of-app channels like Email, Push, SMS, and Chat apps like Slack, you can also use Knock to build great in-app notifications experiences too.
...
- [JS (Non-React Web)](/in-app-ui/js/overview)
