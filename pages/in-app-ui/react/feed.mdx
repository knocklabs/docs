...
Our `@knocklabs/react-notification-feed` library comes pre-built with a real-time feed component that you can drop into your application. In this guide, you'll find common recipes to help you working with the feed.

**Quick links**:

- [Quick start guide on adding a notification feed](/in-app-ui/react/quick-start)
- [`@knocklabs/react-notification-feed` library reference](/in-app-ui/react/reference)
- [`@knocklabs/client` library reference](/in-app-ui/js/reference)
