...
We'll need to wrap our toast producing component in a `KnockFeedProvider` to setup a connection to Knock and connect to the authenticated user's feed. You can read more about the available props for the feed provider in [the reference](/in-app-ui/react/reference#knockfeedprovider).
