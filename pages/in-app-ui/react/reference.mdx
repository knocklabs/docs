...
<Attributes>
  ...
  <Attribute
    name="feedId"
    type="string"
    description="A JWT for the authenticated user to verify their identity with, signed with the private key provided in the Knock dashboard"
  />
  <Attribute
    name="host"
    type="string"
