...
<Attributes>
  ...
  />
  <Attribute name="userToken" type="string" description="A JWT that identifies the authenticated user, signed with the private key provided in the Knock dashboard. Required to secure your production environment." />
  <Attribute
    name="feedId"
    type="string"
  ...
  <Attribute
    name="host"
    type="string"
    description="A custom API host for Knock (Optional)"
  />
  <Attribute
    name="defaultFeedOptions"
    type="FeedClientOptions"
    description="Set defaults for `tenant`, `has_tenant`, `source`, `archived` to scope all subsequent feed queries (Optional)"
  />
  <Attribute
    name="colorMode"
    type="ColorMode"
    description="Sets the theme as either light or dark mode (defaults to light) (Optional)"
  />
  <Attribute
    name="rootless"
    type="boolean"
    description="When set as false, doesn't wrap the children in a `<KnockFeedContainer>` (Optional)"
  />
</Attributes>
