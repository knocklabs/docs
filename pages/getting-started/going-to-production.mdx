...
- [ ] **Enable enhanced security mode**: the generated signing keys will be ignored until you [enable enhanced security mode](/in-app-ui/security-and-authentication) in your Knock environment.
