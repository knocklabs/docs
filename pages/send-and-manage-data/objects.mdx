...
Use plural collection names when possible. The collection name should describe the group of one or many objects within the collection. Good examples of collection names are `code>`,/e> `teams`, `accounts`.
