  ...
  text={
    <>
      <div className="font-bold mb-4">
        Note: some features described here are not enabled for all accounts.
      </div>
      <div>Advanced features not included:</div>
      <ul>
        <li>Per-tenant custom branding</li>
        <li>Per-tenant preferences</li>
      </ul>
      <div>Enabled for all accounts:</div>
      <ul>
        <li>In-app feed segmentation</li>
      </ul>
      <div>
        If custom branding or per-tenant preferences are use-cases that you're
        looking to support with Knock, please{" "}
        <a href="mailto:support@knock.app">get in touch with us</a>.
      </div>
    </>
  }
/>
...
### Custom branding `[advanced feature]`
...
### Custom preferences `[advanced feature]`
