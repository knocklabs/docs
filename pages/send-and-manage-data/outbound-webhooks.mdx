...
<Table
  ...
  rows={[
    ...
    ["message.delivery_attempted", "Occurs when a message delivery attempt fails and may be retried."],
    ["message.undelivered", "Occurs when a message delivery attempt fails permanently. Delivery will not be retried."],
