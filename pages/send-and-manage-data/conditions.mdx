...
A condition variable is always a string formatted like `"<prefix>.<path>"`. Knock uses the variable `prefix` to determine the condition type and the variable `path` to determine where to lookup the data for evaluation.
...
<!-- TODO(KNO-2895): Screenshot of combos -->
