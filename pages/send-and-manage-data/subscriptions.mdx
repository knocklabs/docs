---
title: Subscriptions
description: Learn how to use subscriptions to notify a lists of recipients associated with an object in your data model.
tags: ["subscriptions", "publish subscribe", "pub/sub", "lists", "alerts", "topics"]
