---
title: Subcriptions
description: Learn how to use subscriptions to manage lists of recipients who can be notified from a workflow trigger
tags:
  [
    "subscriptions",
    "tenancy",
...
<Callout
  ...
  text={
    <>
      Subscriptions are currently in beta. If you'd like early access, please{" "}
      <a href="mailto:support@knock.app?subject=Subscriptions beta">
        get in touch
      </a>
      .
    </>
...
const { entries, page_info: pageInfo } = await knock.objects.listSubscribers(
  "project_alerts",
  "project-1",
  { after: null },
);
