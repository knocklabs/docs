...
description: Learn how to use object subscriptions to notify a list of recipients associated with an object in your data model.
tags:
  ["subscriptions", "publish subscribe", "pub/sub", "lists", "alerts", "topics"]
section: Send & manage data
---

Object subscriptions are an extension to [Objects](/send-and-manage-data/objects) and express the relationship between a [Recipient](/send-and-manage-data/recipients) (the subscriber) and an Object.
...
You can subscribe up to 100 recipients to an object at a time by passing one or more `RecipientIdentifiers`. Similar to workflow triggers, a recipient can be inline-identified while being subscribed.
