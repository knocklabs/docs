...
The Knock in-app notification channel provides an easy way to bring in-app notifications into your application. You can use our [pre-built components](/in-app-ui/react/overview) to get up-and-running quickly with feeds, toasts, or inboxes embedded into your application, or you can build custom UI ontop of our [in-app API](/reference#feeds).
