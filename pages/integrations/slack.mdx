...
<Callout 
  emoji="🌠" 
  text={<span><span className="font-bold">Remember:</span> for any customer-facing use cases, you’ll need to give your customers a way to install your Slack app. The simplest way to do this is with <a href="https://api.slack.com/docs/slack-button">the Add to Slack button</a> though Slack now recommends installing with <a href="https://api.slack.com/authentication/oauth-v2">their v2 OAuth flow</a>.</span>}
/>
...
```javascript Object recipient in a workflow trigger
...
<Callout 
  emoji="🌠" 
  text={<span><span className="font-bold">Slack dashboard shortcut.</span> If you’re using a Slack app to message your internal Slack workspace, you can just grab your webhook URL from the Incoming Webhooks section of your <a href="https://api.slack.com/apps">app’s management page</a>.</span>}
/>
