...
<Callout 
  ...
  text={
    <>
      <span className="font-bold">Slack dashboard shortcut.</span> If you’re using a Slack app to message your internal Slack workspace, you can just grab your webhook URL from the Incoming Webhooks section of your <a href="https://api.slack.com/apps">app’s management page</a>.
    </>
  }
/>
