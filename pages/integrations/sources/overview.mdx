...
<Callout
  ...
  text={
    <>
      ...
      if you send Knock a source event that includes a recipient that has not yet been identified in Knock, our system will not generate a workflow run for that user. <br/><br/>
      For use cases such as new signup events, where events will often reach Knock before identify calls, consider <a href="#inline-identify-users-in-a-source-event">inline identification</a> of users in your source events.
    </>
  }
/>
