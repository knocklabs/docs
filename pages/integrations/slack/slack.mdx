---
title: How to send Slack notifications with Knock
description: Setup guide with examples to show you how to send Slack notifications with Knock
tags: ["slack", "chat"]
...
In order to send a Slack message to a recipient, you'll need to have the following [channel data](/send-notifications/setting-channel-data) set for the recipient.
