...
[TODO: A bit on how to receive the callback from Slack?]
...
<Callout
  ...
  text={
    <>
      <span className="font-bold">Potential confusion alert.</span> In the example above, the KNOCK_SLACK_CHANNEL_ID variable is the id of the Knock channel you've created to represent your Slack app within the Knock dashboard. You can get it by going to your "Channels" in the Knock dashboard and then copying the id of your Slack app channel.
    </>
  }
/>
