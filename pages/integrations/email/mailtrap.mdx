...
You can create a new Mailtrap channel in the dashboard under the "Channels" section. From there, you'll need to configure the channel for each environment you have.
...
- `custom_variables.knock_message_id`: the message ID attached to this email
