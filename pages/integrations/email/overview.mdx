...
description: Learn more about how to send Email notifications with Knock
section: Integrations > Email
---

Effortlessly design and deliver emails to downstream providers, without the need to keep HTML templates in your backend codebase.

## Features

- **Easy to get started, and extend**: Knock emails look great out of the box. We include sensible, well tested, default responsive styles so you can get up and running quickly across all major email clients.
- **Block based visual editor**: Don't want to write HTML? No problem! You can use our block based visual editor to get started with creating emails easily.
...
Knock currently has support for the following email providers:
