...
description: Setup guide for Email notifications with SendGrid and Knock
section: Integrations > Email
---

import { Attributes, Attribute } from "../../../components/Attributes";

Knock integrates with [Sendgrid](https://sendgrid.com) to send emails to your recipients.
