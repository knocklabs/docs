  ...
  <Callout
    ...
    text={
      <>
        ...
        doesn't allow the use of non-ASCII characters. You can still use
        recipients with these characters, but at the moment of sending an email
        we will remove them for the <span className="font-bold"> knock_recipient_id</span> tag
      </>
    }
  />
