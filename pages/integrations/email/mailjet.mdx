...
description: Setup guide for Email notifications with Mailjet and Knock
section: Integrations > Email
---

import { Attributes, Attribute } from "../../../components/Attributes";

Knock integrates with [Mailjet](https://mailjet.com/) to send emails to your recipients.
