...
<Callout
  ...
  text={
    <>
      <span className="font-bold">JSON overrides behavior.</span> For this provider, we will
      merge the JSON overrides with the first object under the "Messages" attribute.
    </>
  }
/>
