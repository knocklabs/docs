...
<Callout
  ...
  text={
    <>
      <span className="font-bold">Growth plan feature.</span> The Knock Segment extension is only available on our <a href="https://knock.app/pricing">Growth and Enterprise plans</a>. 
    </>
  }
/>
