...
<Attributes>
  <Attribute name="knock.message_delivered.total" type="count" description="How many messages have been delivered, segmented by `channel`." />
  <Attribute name="knock.message_delivered_error.total" type="count" description="How many deliveries ended in failure, segmented by `channel`." />
