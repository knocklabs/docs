...
We make it effortless to send notifications to chat providers like Slack, Microsoft Teams, and Discord. Meet your users in the tools they use day-in and day-out.
...
- **Drop down to JSON**: if you need to, it's easy to drop down to a fully customizable JSON template to power your chat notifications.
