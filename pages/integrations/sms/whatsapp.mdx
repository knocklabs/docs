...
2. Click on _WhatsApp Account_ on the left sidebar and then select the WhatsApp business app and click the _Add people_ button.
   A popup will appear, choose the recently created system user and check the **full control\_ option** and then click the Assing button.
...
<Attributes>
  <Attribute
    ...
    type="string*"
    description="The authentication token ID from your WhatsApp app"
  />
  <Attribute
