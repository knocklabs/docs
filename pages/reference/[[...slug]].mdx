...
A notify is a notification flow that was created via the Knock dashboard.
...
<Attributes>
  ...
  <Attribute
    ...
    type="string"
    description="Th
    e id of the actor who performed the action associated"
  />
</Attributes>

<Endpoints>
  <Endpoint name="notify" method="POST" path="/notify" />
</Endpoints>
