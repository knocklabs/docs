...
Message changes can also for multiple resources at a time using the batch API, where all message ids given in
the list will have their statuses changed.

Please note: you can only modify a maximum of 100 messages at a time using this endpoint.
...
The bulk change endpoint allows you to modify all, or a subset of messages for a given channel. The messages
