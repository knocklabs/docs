...
<Endpoints>
  <Endpoint name="get-all" method="GET" path="/objects" />
  <Endpoint name="chris-to-update" method="GET" path="chris-to-update" />
</Endpoints>
...
<Section title="Get an object" slug="get-objects">
<ContentColumn>
