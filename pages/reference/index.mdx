...
<Attributes>
  ...
  <Attribute
    name="status"
    type="string[] (optional)"
    description="One or more of `queued`, `sent`, `delivered`, `delivery_attempted`, `undelivered`, `not_sent`. Limits results to items in the given status(es)"
  />
  <Attribute
    name="channel_id"
    type="string (optional)"
...
<Attributes>
  ...
  <Attribute
    name="status"
    type="string"
    description="One of `queued`, `sent`, `delivered`, `delivery_attempted`, `undelivered`, `seen`, `unseen`"
  />
  <Attribute
    name="read_at"
    type="string (optional)"
  ...
  <Attribute
    name="clicked_at"
    type="string (optional)"
    description="When the message or a message link was last clicked"
  />
  <Attribute
    name="inserted_at"
    type="string"
...
<Attributes>
  ...
  <Attribute
    ...
    type="enum"
    description="Limit messages to one of `queued`, `sent`, `delivered`, `delivery_attempted`, `undelivered` (optional)"
  />
  <Attribute
