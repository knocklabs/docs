...
<Endpoints>
  ...
  <Endpoint name="get-user-messages" method="GET" path="/users/:user_id/messages" />
...
<Attributes>
  ...
  <Attribute
    name="status"
    type="string (optional)"
    description="One or more of `queued`, `sent`, `delivered`, `undelivered`, `not_sent`. Limits results to items in the given status(es)"
  />
  <Attribute
    name="channel_id"
    type="string (optional)"
...
Retrieve message events by an id.
...
Returns a list of paginated activities associated with the message. Note: for non batched messages this will always return a single activity. For messages produced after a batch step, this will contain one or more activities.
...
Retrieves a message content by the id.
...
<Endpoints>
  ...
  <Endpoint name="get-object-messages" method="GET" path="/objects/:collection/:id/messages" />
...
Retrieve object messages by collection and id.
...
<Attributes>
  <Attribute name="collection" type="string" description="The collection of the object" />
...
<Attributes>
  ...
  <Attribute
    name="channel_id"
    type="string (optional)"
    description="Limits the results to onlt items that belong to the channel"
  />
</Attributes>
