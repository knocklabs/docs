...
<Callout
  ...
  text={
    <>
      <strong>The default idempotency window for the Knock API is 24 hours.</strong> If you're interested in configuring a different idempotency window for your account, please contact us at <a href="mailto:support@knock.app">support@knock.app</a>.
    </>
  }
/>
...
<Endpoints title="Supported endpoints">
  <Endpoint name="trigger-workflow" method="POST" path="/workflows/:key/trigger" withLink />
</Endpoints>
...
<div class="mt-6">
  <Callout
    ...
    text={
      <>
        <strong>
          Knock scopes this batch rate limit by <code style={{ fontWeight: 600, backgroundColor: "inherit" }}>message_ids</code> and <code style={{ fontWeight: 600, backgroundColor: "inherit" }}>status</code>.
        </strong>{" "}
