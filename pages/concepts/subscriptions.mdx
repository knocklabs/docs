...
```javascript Adding child objects as subscribers of a parent object
...
<Callout
  ...
  text={
    <>
      ...
      <code>parent -> child -> user</code> but no deeper. If you need to support
      a deeper nesting, please{" "}
