...
If you need to send a notification to an entity in your system you should have a look at modelling those as [Objects](/send-and-manage-data/objects). Objects can represent **any non-user entity**.
