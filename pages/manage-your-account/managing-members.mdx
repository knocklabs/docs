...
Owners can use their domains for enabling the account's [auto-join](/manage-your-account/auto-join) policy. With this any new user with the same domain will be joined to the account without the need of an invitation.
