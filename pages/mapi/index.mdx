...
The management API authenticates with a Bearer authentication mechanism using a [service soken](/developer-tools/service-tokens) generated on your account.
