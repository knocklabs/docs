...
<Attributes>
  ...
  <Attribute
    ...
    description={
      <>
        <p>
          Whether to pull all workflows from the specified environment into your present working directory. Defaults to false.
        </p>
        <p>
          When used, all contents in the present working directory will be erased and replaced with all workflows from the specified environment.
        </p>
      </>
    }
  />
...
<Attributes>
  ...
  <Attribute
    ...
    description={
      <>
        <p>
          Whether to pull all translations from the specified environment into your present working directory. Defaults to false.
        </p>
        <p>
          When used, all contents in the present working directory will be erased and replaced with all translations from the specified environment.
        </p>
      </>
    }
  />
