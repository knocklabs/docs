...
<Attributes>
  ...
  <Attribute
    name="--all"
    type="boolean"
    description="Whether to pull all translation files in the environment. Defaults to true."
  />
</Attributes>
...
<Attributes>
  <Attribute
    name="--all"
    type="boolean"
    description="Whether to push all translation files to the environment. Defaults to false."
  />
  <Attribute
    name="--commit"
    type="boolean"
