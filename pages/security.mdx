...
Knock is SOC 2 Type 2 compliant and we perform regular penetration tests. If you'd like copies of either report, please let us know at [security@knock.app](mailto:security@knock.app).

<Image src={"/images/21972-312_SOC_NonCPA.png"} alt="SOC2 Service Organization Logo" width={160} height={160} />
