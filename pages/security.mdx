...
<div className="flex-row items-center space-x-4">
  ...
  <Image src={"/images/gdpr-badge.png"} alt="GDPR badge" width={160} height={160} className="self-center" />
</div>
