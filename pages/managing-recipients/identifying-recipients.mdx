...
To send notifications to a recipient, or to reference a recipient as an actor in a notification Knock requires that the data for that recipient is synchronized and stored in Knock. This process is known as identifying and works across user and object recipients.
