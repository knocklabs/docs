...
<Callout
  ...
  text={
    <>
      <span className="font-bold">Note:</span> The `references` feature in the workflow trigger is net-new behavior that doesn’t exist in the product today but will be added in an upcoming release. We’d love to hear your feedback on the design!
    </>
  }
/>
