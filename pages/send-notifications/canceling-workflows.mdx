...
It's important to understand that only workflows that include a [delay function](/send-notifications/designing-workflows/delay-function) or a [batch function](/send-notifications/designing-workflows/batch-function) can be canceled within Knock, as without the built-in delay of a function Knock will _immediately_ send a notification to your recipients.
