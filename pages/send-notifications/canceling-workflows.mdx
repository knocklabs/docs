...
Canceling a workflow allows you to stop a workflow run mid-execution. This action will stop the sending of messages for one or more recipients. This can be useful in situations like reminder workflows, where a notification needs to be canceled once a user has performed an intended action.
