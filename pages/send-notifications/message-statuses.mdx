...
We attempted to deliver your message, but we encountered an error. If we deem the error retryable and we have not hit our retry limit, we will reenqueue the message for another delivery attempt.
