...
You can configure Knock tracking on a per-environment basis, using your channel's [environment configuration modal](/integrations/overview#per-environment-configurations). Open and link tracking will always default to `OFF` when you first create a channel.
