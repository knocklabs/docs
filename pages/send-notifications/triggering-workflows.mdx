...
Workflow schedules allow you to express complex repeating schedules for your workflow triggers, so that you can trigger workflows on a one-off or a recurring basis for one or more recipients.

[Read more about workflow schedules](/send-and-manage-data/schedules)
