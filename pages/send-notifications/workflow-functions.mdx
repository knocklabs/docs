...
You may want to batch a recipient's notifications into subsets based on the contents of a given notification. In these cases you can provide a batch key to tell Knock to group the notifications within a batch. 
