...
<Callout
  ...
  text={
    <>
      <span className="font-bold">Batching mental model tip.</span> Here's a helpful way to think about batch. By default the batch function batches on a key of recipient_id. When a batch key is provided, it batches on a key of concat(recipient_id, batch_key).  
  }
/>
