...
You may want to batch a recipient's notifications into subsets based on the contents of a given notification. In these cases you can provide a batch key, which resolves to a value in your `data` payload to batch the notification by.
