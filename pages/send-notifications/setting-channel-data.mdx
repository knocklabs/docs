...
For both user and object recipients, channel data can be specified inline during a [workflow trigger call](http://localhost:3002/send-notifications/triggering-workflows#identifying-recipients-inline).
...
```json Example inline channel data definition
{
  "channel_data": {
