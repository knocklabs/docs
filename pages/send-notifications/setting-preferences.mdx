...
### Setting the user's preferences with conditions

You can use the `users.setPreferences` method to also set preferences with conditions that are evaluated. Please refer to the [documentation on preference conditions](/send-and-manage-data/preferences#preference-conditions) to learn more.
