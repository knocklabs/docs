...
<Callout
  ...
  text={
    <>
      <span className="font-bold">Example an example.</span>{" "}
      Follow this{" "}
      <a href="https://github.com/knocklabs/example-collaboration-app/blob/main/db/seeds.ts#L103">
        link
      </a> to see an example of how to set preferences with conditions.
    </>
  }
/>
...
<Callout
  ...
  text={
    <>
      <span className="font-bold">See an example.</span>{" "}
      Check out{" "}
      <a href="https://github.com/knocklabs/example-collaboration-app/blob/main/db/seeds.ts#L103">
        our example app
      </a> to see the bulk preferences API being used within the context of a collaboration app.
    </>
  }
/>
...
<Callout
  ...
  text={
    <>
      <span className="font-bold">See an example.</span> Check out our example app for real examples of 
      {" "}
      <a href="https://github.com/knocklabs/example-collaboration-app/blob/main/app/users/components/NotificationPreferencesModal.tsx#L42">
        getting
      </a>{" "}
      and{" "}
      <a href="https://github.com/knocklabs/example-collaboration-app/blob/main/app/users/components/NotificationPreferencesModal.tsx#L93">
        setting
      </a>{" "}
