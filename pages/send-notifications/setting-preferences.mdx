...
<Callout
  ...
  text={
    <>
      ...
      <a href="https://github.com/knocklabs/example-collaboration-app/blob/main/db/seeds.ts#L103">
        link
      </a> to see an example of the bulk preferences API being used on our example app.
    </>
  }
/>
...
<Callout
  ...
  text={
    <>
      <span className="font-bold">Example app.</span> Here
      you can see how you can see and example of {" "}
