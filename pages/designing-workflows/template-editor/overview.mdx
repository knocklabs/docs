...
<Callout
  ...
  text={
    <>
      All templates in Knock use Liquid as the templating language. You can
      learn more about Liquid in{" "}
...
## Inserting variables into your notification template (personalizing notifications)

To inject a variable into your notification template, enclose it with double curly braces: `{{ a_variable }}`.

You can use curly braces to reference a number of different variable types in your templates. Here are some of the most common types, but the [full list is available here](/designing-workflows/references/variables).
