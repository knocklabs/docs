...
The primary use case for template variants is localization, but you can also use your own custom template variant conditions to power other use cases (such as creating variants of a given tempalte for certain `tenants`).
