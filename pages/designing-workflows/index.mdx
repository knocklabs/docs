...
Each workflow step can have one or more conditions that determine, at workflow execution time, if the step should execute. Conditions are one way you can add powerful control flow logic to your notification workflows.
