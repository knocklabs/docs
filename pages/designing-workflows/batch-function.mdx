...
Optionally, you can also set a maximum limit for the number of activities allowed to be accumulated in a given batch, anywhere between 2 and 1000 activities.
