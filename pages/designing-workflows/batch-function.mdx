...
Right now there's no way to conditionally close the batch window based on the number of items contained in the batch. If this is blocking your adoption of Knock, [please get in touch](mailto:support@knock.app).
