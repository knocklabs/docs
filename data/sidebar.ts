...
const sidebarContent: SidebarSection[] = [
  {
    ...
    desc:
      "A technical and non-technical introduction to the features of Knock, and a step-by-step guide to get you going in minutes.",
    pages: [
      { slug: "/what-is-knock", title: "What is Knock?" },
      { slug: "/how-knock-works", title: "How Knock works" },
      { slug: "/quick-start", title: "Quick start" },
      { slug: "/knocks-features", title: "Knock's features" },
    ],
  },
  {
    ...
    desc:
      "Learn the ins-and-outs of how to get data flowing into Knock to power your notifications",
    pages: [
  ...
  },
  {
    ...
    desc:
      "See how to use Knock to start designing and sending out your notifications, including understanding more advanced workflows such as batching.",
    pages: [
  ...
  },
  {
    ...
    desc:
      "A guide for how to integrate Knock into your clientside applications",
  ...
  },
  {
    ...
    desc:
      "Everything you need to know about how to display notification feeds back to your users",
    pages: [
  ...
  },
  {
    ...
    slug: "/preferences",
    desc:
      "An overview of integrating our preference components into your product",
