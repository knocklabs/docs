...
<AccordionGroup>
  <Accordion
    title="Can I upsert tenant-scoped translations directly to production?"
    anchorSlug="faq-upsert-tenant-translations-to-production"
  >
  ...
  <Accordion
    title="Can I manage tenant-scoped translations in the dashboard?"
    anchorSlug="faq-tenant-translations-in-dashboard"
  >
  ...
  <Accordion
    title="Can I use per-tenant translations to create per-tenant templates?"
    anchorSlug="faq-per-tenant-translations-for-templates"
  >
