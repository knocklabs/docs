...
<AccordionGroup>
  ...
  <Accordion title="Is the order of my batch activities guaranteed?">
    We cannot guarantee the order of requests made within quick succession (&lt; 2s) and the order they appear in the batch. If they need a guaranteed order, then you will need to enqueue requests with latency in your system.
  </Accordion>
</AccordionGroup>
