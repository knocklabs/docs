...
<Callout
  type="info"
  title="Debugging batched workflow runs."
  text={
    <>
      As new <code>activities</code> are added to an open batch, their
      underlying workflow runs terminate. See{" "}
      <a href="/send-notifications/debugging-workflows#debugging-workflows-with-a-batch-step">
...
<Callout
  ...
  text={
    <>
      ...
      <a href="#setting-the-workflow-version-mode">pinned mode</a>, the workflow
...
<AccordionGroup>
  <Accordion title="Using a fixed timestamp" anchorSlug="using-a-fixed-timestamp">
  ...
  <Accordion title="Using durations" anchorSlug="using-durations">
  ...
  <Accordion title="Using window rules" anchorSlug="using-window-rules">
...
<Callout
  ...
  text={
    <>
      ...
      default to <code>pinned</code> mode. Please review{" "}
      <a href="#updating-workflows-with-batch-steps">
...
<AccordionGroup>
  ...
  <Accordion title="What happens to an open batch when I update the workflow?" anchorSlug="faq-open-batch-workflow-update">
  ...
  <Accordion title="When should I use pinned workflow version mode?" anchorSlug="faq-pinned-workflow-version-mode">
  ...
  <Accordion title="Can I close a batch early?" anchorSlug="faq-close-batch-early">
  ...
  <Accordion title="How can items be removed from a batch?" anchorSlug="faq-removing-items-from-batch">
  ...
  <Accordion title="How many items can a batch contain?" anchorSlug="faq-batch-item-limit">
  ...
  <Accordion title="How many items can I reference in my templates from a batch?" anchorSlug="faq-batch-items-in-templates">
  ...
  <Accordion title="How can I change the order of the batch to retrieve the last 10 items instead of the first 10 items?" anchorSlug="faq-batch-item-order">
  ...
  <Accordion title="Once activities are batched, how can I access them?" anchorSlug="faq-accessing-batched-activities">
  ...
  <Accordion title="Can I use multiple batch steps in a single workflow?" anchorSlug="faq-multiple-batch-steps-per-workflow">
  ...
  <Accordion title="Is batching the same as digesting notifications?" anchorSlug="faq-batching-vs-digesting">
  ...
  <Accordion title="Do you support per-recipient batch windows and timezones?" anchorSlug="faq-per-recipient-batch-windows-timezones">
  ...
  <Accordion title="How can I query for messages or feed items that were generated from activities with given workflow trigger call data?" anchorSlug="faq-query-messages-by-trigger-data">
  ...
  <Accordion title="Can I dynamically extend the batch window?" anchorSlug="faq-dynamic-batch-window-extension">
  ...
  <Accordion title="Can I close a batch window by the number of items in the batch?" anchorSlug="faq-close-batch-by-item-count">
  ...
  <Accordion title="Why are some attachments missing from my batched email?" anchorSlug="faq-missing-attachments-batched-email">
  ...
  <Accordion title="Is the order of my batch activities guaranteed?" anchorSlug="faq-batch-activity-order">
