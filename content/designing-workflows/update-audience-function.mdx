...
<AccordionGroup>
  <Accordion title="When should I use an update audience step vs. the audiences API?" anchorSlug="faq-update-audience-step-vs-audiences-api">
  ...
  <Accordion title="Can I use this step with dynamic audiences?" anchorSlug="faq-dynamic-audiences">
  ...
  <Accordion title="Can I target a user other than the current recipient?" anchorSlug="faq-target-non-recipient-user">
