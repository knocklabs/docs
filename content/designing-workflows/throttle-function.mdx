...
<AccordionGroup>
  ...
  <Accordion title="Can I extend the throttle window past 31 days?">
    Currently, you cannot extend the throttle window past 31 days. If you need to 
    throttle a workflow to run at most once per recipient, you can consider using
    [workflow trigger frequency](/designing-workflows/triggering-workflows#workflow-trigger-frequency) instead.
  </Accordion>
</AccordionGroup>
