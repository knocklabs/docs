...
<AccordionGroup>
  <Accordion
    title="Can I use a dynamic throttle window?"
    anchorSlug="faq-dynamic-throttle-window"
  >
  ...
  <Accordion
    title="What happens when a throttle is hit?"
    anchorSlug="faq-throttle-hit-behavior"
  >
    When a throttle is hit, the workflow will stop execution. You will be able
    to see this in your workflow run logs.
  </Accordion>
  <Accordion
    title="Can an active throttle be canceled?"
    anchorSlug="faq-cancel-active-throttle"
  >
  ...
  <Accordion
    title="What’s the maximum time a throttle can be open for?"
    anchorSlug="faq-max-throttle-window"
  >
  ...
  <Accordion
    title="Can I have multiple throttle steps per workflow?"
    anchorSlug="faq-multiple-throttle-steps-per-workflow"
  >
    Absolutely, each throttle step is executed independently in a workflow, so
    you can have as many as you need.
  </Accordion>
  <Accordion
    title="Can I throttle across workflows?"
    anchorSlug="faq-throttle-across-workflows"
  >
  ...
  <Accordion
    title="Can I extend the throttle window past 31 days?"
    anchorSlug="faq-throttle-window-past-31-days"
  >
