...
| `subscription.object` | The object that the recipient is subscribed to. Only available when a workflow is triggered via a [Subscription](/concepts/subscriptions).                                                     |
