...
| `$data`            | The complete data passed to the workflow trigger. You can use this property when you need to pass the whole data payload to your templates.                                                                                           |
...
<Callout
  ...
  text={
    <>
      ...
      template as top-level values (<strong>not nested under data</strong>) and
      is deep-merged into the set of variables above.
    </>
  }
/>
