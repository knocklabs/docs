...
<Callout
  ...
  text={
    <>
      Random cohort branch function is currently in beta. If you'd like early
      access, or this is blocking your adoption of Knock, please{" "}
      <a href="mailto:support@knock.app?subject=Random cohort branch function">
        get in touch
      </a>
      .
    </>
...
<Callout
  ...
  text={
    <>
      ...
      random cohort branch step performance. Stay tuned for updates.
    </>
  }
/>
...
<AccordionGroup>
  ...
  <Accordion title="What's the maximum depth of nested random cohort branch steps I can have?">
    The maximum depth for random cohort branches is set at 5. If you have needs
    that go beyond this, please reach out to discuss.
  </Accordion>
</AccordionGroup>
