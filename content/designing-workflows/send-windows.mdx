...
<Callout
  type="warn"
  title="Send windows do not delay workflow execution."
  text="Workflow execution continues after any channel step produces a message, regardless of whether that message is queued by a send window. If your workflow has subsequent delay steps, consider how those delays may interact with your send windows."
/>
