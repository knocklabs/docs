...
- [Update data](/designing-workflows/update-data-function) (update workflow data state with computed or static values)
<<<<<<< HEAD

**Data functions**

- [Update user, tenant, and object](/send-notifications/designing-workflows/update-recipient) (update a user's, tenant's, or object's properties in Knock during a workflow run)
=======
>>>>>>> 5656ca6626b6c556b99b79297aa68c515edf1119
