...
- [Random cohort branch](/send-notifications/designing-workflows/random-cohort-branch-function) (randomly assign recipients to percentage-based cohorts for A/B testing and experimentation)
