...
<Callout
  ...
  text={
    <>
      ...
      <a href="/concepts/channels#channel-visibility">
...
- [Wait for event](/send-notifications/designing-workflows/wait-for-event-function) (pause a workflow until a matching integration source event is received or the wait time expires)
