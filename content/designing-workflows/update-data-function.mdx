...
<figure>
  ...
  />
  <figcaption>Update data function step in the workflow builder.</figcaption>
</figure>
...
<figure>
  <Image
    ...
    width={1015}
    height={600}
    alt="Code editor mode for configuring an update data function."
    className="rounded-md mx-auto border border-gray-200"
  />
  <figcaption>
...
<AccordionGroup>
  <Accordion title="When should I use an update data function vs. a fetch function?" anchorSlug="faq-update-data-vs-fetch-function">
  ...
  <Accordion title="Can I set nested properties?" anchorSlug="faq-nested-properties">
  ...
  <Accordion title="What happens if a Liquid expression fails?" anchorSlug="faq-liquid-expression-failure">
  ...
  <Accordion title="Can I reference my updated `data` in subsequent workflow steps?" anchorSlug="faq-reference-updated-data-later-steps">
