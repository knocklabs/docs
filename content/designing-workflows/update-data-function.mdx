...
An update data function updates properties on the workflow `data` state as a step in a workflow. Any data set by an update data function is merged into the original trigger `data` provided on workflow trigger and made immediately available to all subsequent steps in the workflow.
...
<figure>
  <Image
    src="/images/functions/data/workflow-data/overview.png"
    width={1015}
    height={600}
    alt="Update data function step in the workflow builder."
...
<figure>
  <Image
    src="/images/functions/data/blob-mode.png"
    width={1015}
    height={600}
    alt="Key-value and code editor modes for configuring an update data function."
    className="rounded-md mx-auto border border-gray-200"
  />
  <figcaption>
    Key-value and code editor modes for configuring an update data function.
  </figcaption>
</figure>

<figure>
  <Image
    src="/images/functions/data/templated-data.png"
    width={1015}
    height={600}
    alt="Using Liquid expressions for templated values in an update data function."
    className="rounded-md mx-auto border border-gray-200"
  />
  <figcaption>
    Using Liquid expressions for templated values in an update data function.
  </figcaption>
</figure>
...
<figure>
  <Image
    src="/images/functions/data/nested-keys.png"
    width={1015}
    height={600}
    alt="How top-level and nested keys are merged in update data function steps."
    className="rounded-md mx-auto border border-gray-200"
  />
  <figcaption>
    How top-level and nested keys are merged in update data function steps.
  </figcaption>
</figure>
...
<figure>
  <Image
    src="/images/functions/data/workflow-data/logging-update-workflow-data.png"
    width={1015}
    height={600}
    alt="Viewing update data function step in the workflow run logs."
    className="rounded-md mx-auto border border-gray-200"
  />
  <figcaption>
