...
The trigger workflow function uses strings or [Liquid](/designing-workflows/template-editor/api-reference-liquid-helpers) variables to define the trigger data for the nested workflow. You can reference any variables and data available in the parent workflow run.
