...
After a batch closes, this expression uses the cancellation key of the continuing workflow run—the run that opened the batch—not the keys of other activities in the batch.
