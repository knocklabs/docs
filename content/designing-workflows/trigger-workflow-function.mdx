...
![Configure trigger workflow function settings](/images/functions/functions_trigger_workflow_settings.png)
...
The trigger workflow function uses strings or [Liquid](/designing-workflows/template-editor/reference-liquid-helpers.mdx) variables to define the trigger data for the nested workflow. You can reference any variables and data available in the parent workflow run.
