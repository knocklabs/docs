...
3. Checks the [recipient's preferences](/concepts/preferences) to see if they have opted out from receiving notifications on this channel or from this workflow.
