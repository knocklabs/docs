...
Slack and Discord channel steps can also [reply to a message from a previous workflow step or in an existing thread](/designing-workflows/replying-to-chat-messages).
