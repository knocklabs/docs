...
When any of the checks above (conditions, recipient data, preferences) cause a step not to execute, the step is **skipped**. A skipped step does not produce a message, but the workflow continues to execute subsequent steps.
