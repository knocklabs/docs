...
The AI agent function runs a prompt on an AI model of your choice and merges the response into your workflow state. You can use it to enrich recipient data, personalize messaging, and bring AI-powered context into your notification templates.
...
<Table
  headers={["Model", "Description", "Credit cost"]}
  rows={[
    ["Claude Haiku 4.5", "A small, fast model for quick tasks.", "1 credit"],
    [
      "Claude Sonnet 4.6",
      "A general-purpose model for complex tasks.",
      "2 credits",
    ],
    [
      "Claude Opus 4.6",
      "A large, powerful model for complex tasks.",
      "3 credits",
    ],
    [
      "OpenAI GPT-4o",
      "The latest generation of OpenAI's GPT model.",
      "4 credits",
    ],
    [
      "OpenAI GPT-4o-mini",
      "The smallest generation of OpenAI's GPT model.",
      "5 credits",
    ],
  ]}
/>
