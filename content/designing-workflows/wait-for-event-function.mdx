...
[Goal conditions](/concepts/goals#goal-conditions) reuse a subset of this event model (integration source and dynamic audience entry/exit) to define measurable outcomes outside of a workflow run.
