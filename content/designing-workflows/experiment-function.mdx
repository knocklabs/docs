...
<Callout
  ...
  text={
    <>
      Experiment function is currently in beta. If you'd like early
...
<Image
  ...
  alt="A workflow with experiment steps splitting recipients into cohorts"
  width={1710}
  height={550}
...
<AccordionGroup>
  ...
  <Accordion title="What's the maximum depth of nested experiment steps I can have?">
    The maximum depth for experiment steps is set at 5. If you have needs
