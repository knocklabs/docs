...
<AccordionGroup>
  <Accordion
    title="Can I use an in-app guide step in a broadcast?"
    anchorSlug="faq-in-app-guide-step-in-broadcasts"
  >
    Yes. In-app guide steps are supported in both workflows and broadcasts.
  </Accordion>
  <Accordion
    title="Does the recipient see the guide immediately?"
    anchorSlug="faq-guide-visible-immediately"
  >
  ...
  <Accordion
    title="Can I remove a recipient's eligibility once they're enrolled?"
    anchorSlug="faq-remove-recipient-eligibility"
  >
  ...
  <Accordion
    title="What happens if the referenced guide is archived or returned to an uncommitted state?"
    anchorSlug="faq-archived-or-uncommitted-guide"
  >
