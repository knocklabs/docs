...
On the reusable request, **input schema** is a [JSON Schema](https://json-schema.org/) object that describes the allowed input properties (types, required fields, default values, and so on).
