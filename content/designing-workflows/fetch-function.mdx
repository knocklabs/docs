...
On the reusable request, **input schema** is a <a href="https://json-schema.org/" target="_blank">JSON Schema</a> object that describes the allowed input properties (types, required fields, default values, and so on).

To define a schema, navigate to the reusable request editor and click "Define schema" on the left side.

<figure>
  <Image
    src="/images/concepts/reusable-steps/define-schema.png"
    width={1052}
    height={958}
    alt="Defining an input schema for a reusable request."
    className="rounded-md mx-auto border border-gray-200"
  />
</figure>
...
<figure>
  <Image
    src="/images/concepts/reusable-steps/workflow-usage-2.png"
    width={1052}
    height={958}
    alt="Using a reusable request in a workflow."
    className="rounded-md mx-auto border border-gray-200"
  />
</figure>
...
<figure>
  <Image
    src="/images/concepts/reusable-steps/schema-preview.png"
    width={1052}
    height={958}
    alt="Previewing schema inputs for a reusable request."
    className="rounded-md mx-auto border border-gray-200"
  />
</figure>
...
<figure>
  <Image
    src="/images/concepts/reusable-steps/request-usage.png"
    width={1052}
    height={958}
    alt="Using values in the request template for a reusable request."
    className="rounded-md mx-auto border border-gray-200"
  />
</figure>
...
<Callout
  type="warning"
  title="Note:"
  text="The reusable request must be committed for any changes to take effect and for inputs to be visible in workflows."
/>
