...
These steps support upserting. If you specify an object id that does not yet exist in that collection in Knock, the object will be created with the properties you set.
