...
For more details on how preference merging works and how to modify the merge behavior, see the [preferences FAQ](/preferences/overview#frequently-asked-questions).
