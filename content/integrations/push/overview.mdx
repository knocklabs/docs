...
<Callout
  ...
  text={
    <>
      <strong>Note.</strong> Channel groups are currently enabled on an on-demand basis. If you'd like it enabled for your account, you can request access in the dashboard or reach out to us at{" "}
