...
- **Template settings.** Overrides set on the template by clicking the gear icon (⚙️) at the top of the template editor to open the template settings modal. Template-level overrides take precedence over channel-level overrides.
