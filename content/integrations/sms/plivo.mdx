...
<AccordionGroup>
  ...
  <Accordion title="Overrides" anchorSlug="configuration-overrides">
    When configured, the optional payload overrides set here will apply to all SMS notifications sent from this channel in the configured environment. Learn more about SMS channel overrides [here](/integrations/sms/settings-and-overrides#provider-json-overrides).
    
    <Attributes>
      <Attribute
        name="Payload overrides"
        nameSlug="/integrations/sms/settings-and-overrides#provider-json-overrides"
