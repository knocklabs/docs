...
<Callout
  ...
  text={
    <>
      Email client previews are available on all paid plans (Starter and up). On
      the free plan, the client previews button is visible but disabled. Hover
      over it to see a tooltip with upgrade options.
    </>
  }
/>
