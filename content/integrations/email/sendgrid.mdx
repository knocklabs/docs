...
<ul style={{ marginLeft: "var(--tgph-spacing-8)" }}>
  <Text as="li" size="2" ml="4" data-tgph-list-item>
    {
      <>
        <strong>
          <a
            href="https://www.twilio.com/docs/sendgrid/for-developers/tracking-events/event#delivered-events"
            target="_blank"
  ...
  <Text as="li" size="2" ml="4" data-tgph-list-item>
    {
      <>
        <strong>
          <a
            href="https://www.twilio.com/docs/sendgrid/for-developers/tracking-events/event#bounce-and-blocked-events"
            target="_blank"
            rel="noopener noreferrer"
          >
            Bounce
  ...
  <Text as="li" size="2" ml="4" data-tgph-list-item>
    {
      <>
        <strong>
          <a
            href="https://www.twilio.com/docs/sendgrid/for-developers/tracking-events/event#dropped-events"
            target="_blank"
            rel="noopener noreferrer"
          >
            Dropped
  ...
  <Text as="li" size="2" ml="4" data-tgph-list-item>
    {
      <>
        <strong>
          <a
            href="https://www.twilio.com/docs/sendgrid/for-developers/tracking-events/event#spam-report-events"
            target="_blank"
            rel="noopener noreferrer"
          >
            Spam Report
        ...
        {" - Tracks spam complaints reported by recipients"}
      </>
    }
  </Text>
</ul>
...
2. **Verify event selection.** Ensure the "Delivered", "Bounce", "Dropped", and "Spam Report" events are selected in your Event Webhook configuration.
