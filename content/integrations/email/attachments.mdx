...
1. Set an attachment key in your email template to tell Knock how to resolve attachments you send in the data payload of your trigger call. To set an attachment key, click the "⚙️" icon at the top of the email template editor, then set your desired key under the "Attachment key" field.
