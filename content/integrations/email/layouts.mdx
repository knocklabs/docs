...
Regardless of the layout you've chosen for a given email step, you'll be able to use the [visual template editor](/send-notifications/template-editor#visual-editing-with-drag-and-drop-components) to compose the `content` of your email template.
