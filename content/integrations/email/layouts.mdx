...
### Why am I seeing duplicate Knock branding in my emails?

<Callout
  emoji="💡"
  text={
    <>
      <strong>Duplicate HTML tags.</strong> The most common cause of duplicate
      branding in email notifications is having duplicate HTML{" "}
      <code style={{ fontWeight: 600, backgroundColor: "inherit" }}>
        &lt;body&gt;
      </code>{" "}
      tags in your layout. Since Knock email layouts already contain a{" "}
      <code style={{ fontWeight: 600, backgroundColor: "inherit" }}>
        &lt;body&gt;
      </code>{" "}
      tag, including another one in your template will cause rendering issues,
      including duplicate branding elements. To fix this:
      <ul>
        <li>
          Make sure your email templates don't include{" "}
          <code style={{ fontWeight: 600, backgroundColor: "inherit" }}>
            &lt;body&gt;
          </code>{" "}
          tags, as noted in the{" "}
          <a href="#layouts-and-the-visual-template-editor">
            layouts and the visual template editor
          </a>{" "}
          section.
        </li>
        <li>
          If importing HTML from another source, remove any{" "}
          <code style={{ fontWeight: 600, backgroundColor: "inherit" }}>
            &lt;head&gt;
          </code>{" "}
          and{" "}
          ...
          tags before saving your template.
        </li>
        <li>
          Alternatively, select "No layout" in the template settings if you need
          to use a complete HTML document as your template.
        </li>
      </ul>
    </>
  }
