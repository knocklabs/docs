...
<AccordionGroup>
  <Accordion title="What is the limit on the number of emails I can send?" anchorSlug="faq-email-send-limit">
    You can send up to 100 emails per month for free.
  </Accordion>
  <Accordion title="Who can I send emails to?" anchorSlug="faq-email-recipients">
  ...
  <Accordion title="What happens when I exceed the limit?" anchorSlug="faq-exceeding-email-limit">
  ...
  <Accordion title="How do I use the Knock test channel?" anchorSlug="faq-knock-test-channel-usage">
  ...
  <Accordion title="Can I use this provider for production use?" anchorSlug="faq-test-provider-in-production">
