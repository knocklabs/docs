...
- **CSS inlining**: By default, Knock will inline all CSS included with your emails to ensure maximum compatibility across email clients. This behavior can be disabled per-environment as a setting on your email channel's <a href="https://dashboard.knock.app/~/settings/integrations/channels" target="_blank">configuration</a>.
...
<Callout
  type="info"
  title="Delivery tracking methods."
  text={
    <>
