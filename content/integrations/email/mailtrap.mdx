...
You can create a new Mailtrap channel in the dashboard under the under the **Channels and sources** tab in your account settings. From there, you'll need to configure the channel for each environment you have.
