...
You can create a new Mailgun channel in the dashboard under the **Channels and sources** tab in your account settings. From there, you'll need to configure the channel for each environment you have.
