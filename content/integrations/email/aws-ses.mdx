...
<Callout>
  ...
  >
    ...
    <li>Knock link and open tracking</li>
    <li>Per environment configuration</li>
    <li>Sandbox mode</li>
  </ul>
</Callout>
...
<AccordionGroup>
  <Accordion title="Settings">
    ...
    **Provider settiings for AWS SES**
    <Attributes>
      <Attribute
        name="AWS region"
        type="string*"
      ...
      <Attribute
        ...
        type="Access Key | External ID*"
        description="The authentication scheme to use for your SES channel"
      />
      <Attribute
        name="Access key ID"
        type="string*"
  ...
  <Accordion title="Overrides">
    When configured, these optional overrides will apply to all emails sent from this channel. Learn more about email channel overrides [here](/integrations/email/settings).
  ...
  <Accordion title="Conditions">
    Set optional per-environment [conditions](/integrations/overview#channel-conditions) for this channel. These conditions are evaluated each time a workflow run encounters this channel step. If the conditions are not met, the step will be skipped.
  </Accordion>
</AccordionGroup>
