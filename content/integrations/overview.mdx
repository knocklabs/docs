...
<Callout
  ...
  text={
    <>
      ...
      support will soon be available. For help configuring a channel group, reach out to
      us at <a href="mailto:support@knock.app">support@knock.app</a>.
    </>
  }
/>
...
<AccordionGroup>
  ...
  <Accordion title="In-app">
    ...
    - [Knock guides](/in-app-ui/guides/overview)
  </Accordion>
