...
This documentation covers how to use our Heap extension to send Knock's normalized notification data into <a href="https://heap.io" target="_blank" rel="noopener">Heap</a> to forward on to your data warehouse or other tools where you run data analysis, such as Amplitude or Mixpanel.
...
You can find more information about custom events and how to use them in the <a href="https://help.heap.io/hc/en-us/articles/18700111173532-How-to-use-custom-events-to-build-new-events" target="_blank" rel="noopener">Heap documentation</a>
...
Knock uses the Heap <a href="https://developers.heap.io/reference/bulk-track" target="_blank" rel="noopener">Bulk track endpoint</a> for sending event data to Heap. You can find an example payload of what you can expect from Knock events coming into Heap below.
