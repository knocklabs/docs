...
<Table
  ...
  rows={[
    ...
    [
      ...
      "Occurs when a recipient reports an email as spam to the provider. This is only available on select email providers with delivery status webhooks configured to send complaint events.",
    ],
