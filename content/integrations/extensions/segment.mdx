...
This documentation covers how to use our Segment extension to send Knock's normalized notification data into <a href="https://segment.io" target="_blank" rel="noopener">Segment</a> to forward on to your data warehouse or other tools where you run data analysis, such as Amplitude or Mixpanel.
...
Knock uses the Segment <a href="https://segment.com/docs/connections/spec/track/" target="_blank" rel="noopener">Track spec</a> for the event data we pass to Segment. You can find an example payload of what you can expect from Knock events coming into Segment below.
