...
Our data warehouse connector syncs data from our `messages` table. Each `message` represents a notification that was executed for a single recipient. You can read more about messages as a concept [here](https://docs.knock.app/concepts/messages).
...
Our data warehouse connector syncs data from our `recipients` table. Each row captures the properties and preferences of a [Recipient](https://docs.knock.app/concepts/recipients) at a given moment in time.
    ...
    <Table
      ...
      rows={[
        ...
        ["recipient_type", "string",
            <div key="recipient_type_body">
              The <a target="_blank" rel="noreferrer" href="https://docs.knock.app/concepts/recipients"> type of recipient recorded</a>
            </div>,
        ],
        ["event_type", "string",
