        ...
        [
          ...
          <div key="exec_mode_body">
            ...
            <ul>
              ...
              <li>
                <code>trigger</code> - real execution of a workflow from the API
              </li>
              <li>
                <code>rehearse</code> - test run of a workflow
              </li>
              <li>
                <code>integration</code> - triggered from an external integration (e.g. Segment)
              </li>
              <li>
                <code>rehearse_integration</code> - test run of an integration-triggered message
              </li>
              <li>
                <code>scheduled</code> - scheduled workflow execution
              </li>
              <li>
                <code>workflow_step_trigger</code> - message triggered by a workflow step
              </li>
              <li>
                <code>broadcast_trigger</code> - real execution of a broadcast
              </li>
              <li>
