...
Knock supports ingesting any of PostHog's [supported events](https://posthog.com/docs/cdp/destinations/knock), so you can map them to actions as your needs evolve.
