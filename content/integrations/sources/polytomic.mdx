...
Knock integrates with <a href="https://polytomic.com" target="_blank" rel="noopener">Polytomic</a> as a downstream destination to sync customer and event data from your data warehouse.
