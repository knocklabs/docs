...
<Steps>
  ...
  <Step title="Finalize your sync">
    ...
    You can now click "Finish" to add the sync and run it whenever you’d like.  Refer to <a href="https://hightouch.com/docs/syncs/overview" target="_blank" rel="noopener noreferrer">Hightouch’s documentation</a> for more information on syncs.
