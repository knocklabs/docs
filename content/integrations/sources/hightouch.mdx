...
Knock integrates with <a href="https://hightouch.com" target="_blank" rel="noopener">Hightouch</a> as a downstream destination to sync customer and event data from your data warehouse.
...
You can use the <a href="https://hightouch.com/docs/destinations/http-request" target="_blank" rel="noopener">HTTP request destination</a> within Hightouch to sync your customer data from your data warehouse into Knock.
...
2. Set an `Authorization` header, with the value set to `Bearer <your Knock secret API key>`. You can find your secret API key in <a href="https://dashboard.knock.app" target="_blank" rel="noopener">your dashboard</a> under **Platform** > **API keys**
...
<Steps>
  ...
  <Step title="Finalize your sync">
    ...
    You can now click "Finish" to add the sync and run it whenever you’d like.  Refer to <a href="https://hightouch.com/docs/syncs/overview" target="_blank" rel="noopener">Hightouch’s documentation</a> for more information on syncs.
