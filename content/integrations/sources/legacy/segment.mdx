...
<AccordionGroup>
  <Accordion
    title="Can I use a single Segment event to trigger multiple workflows?"
    anchorSlug="faq-one-segment-event-multiple-workflows"
  >
  ...
  <Accordion
    title="Can I use multiple different Segment events to trigger the same workflow?"
    anchorSlug="faq-multiple-segment-events-one-workflow"
  >
