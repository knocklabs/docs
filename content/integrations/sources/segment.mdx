...
Knock supports ingesting any of Segment's [supported events](https://segment.com/docs/connections/spec/), so you can map them to actions as your needs evolve.
