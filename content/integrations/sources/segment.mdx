...
Once you're here, click the **Configure Webhooks (Actions)** button in the top right. Now, you'll be in a setup flow to configure your webhook.
...
Now you'll see a **Basic Settings** page. Check the **Enable Destination** button and click **Save changes.** At the top of the page, you'll see we're on the **Settings** tab; navigate to the **Mappings** tab now.
...
1. **Select events to map and send:** If you'd like to send all events to Knock, you can add the condition **Event type is Track** and a condition for **Event type is Identify.** Make sure you change the top operator to **any** instead of all.
