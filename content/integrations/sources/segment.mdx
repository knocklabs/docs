...
<Callout
  ...
  text={
    <>
      ...
      When you commit and publish your workflows to other environments, the workflow trigger configurations will be included automatically as part of the workflow definition.
    </>
  }
/>
...
<AccordionGroup>
  <Accordion title="Can I use a single Segment event to trigger multiple workflows?">
    ...
    select an event from Segment to view a list of workflow triggers configured for that
    ...
    before saving and committing these workflow trigger changes to your Development
    environment.
  </Accordion>
