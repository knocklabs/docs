...
<Steps>
  ...
  <Step title="Add the webhook endpoint in WorkOS">
    In the [WorkOS dashboard](https://dashboard.workos.com/webhooks), click "Add endpoint." Paste the Knock webhook URL and select the events you want WorkOS to send.
  </Step>
...
You can modify the default action mappings or add new ones for any event type Knock receives from WorkOS. For details on how field mapping works with dot-notation paths, see the [HTTP source](/integrations/sources/http) page.
