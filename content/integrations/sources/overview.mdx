...
When a source sends an event to a Knock environment, Knock will match that event with any configured workflow triggers in that environment.
...
<Callout
  ...
  text={
    <>
      ...
      If you exceed this limit, Knock will not process your workflow triggers
      and instead generate an error log. <br />
      <br />
