...
<Image
  src="/images/integrations/sources/event-action-mapping.png"
  alt="The event-to-action mapping configuration in the Knock dashboard, showing how incoming event fields map to action parameters"
  width={2912}
  height={1448}
