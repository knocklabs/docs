...
A source is any platform that can pass event and/or user data into Knock. These can be CDPs (such as <a href="https://segment.com" target="_blank" rel="noopener">Segment</a> and <a href="https://rudderstack.com" target="_blank" rel="noopener">RudderStack</a>) or reverse ETLs (such as <a href="https://hightouch.com/" target="_blank" rel="noopener">Hightouch</a> and <a href="https://www.getcensus.com/" target="_blank" rel="noopener">Census</a>.) The incoming events from these services can be used to orchestrate actions in Knock such as creating/updating users and triggering workflows.
