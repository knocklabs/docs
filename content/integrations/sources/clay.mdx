...
<Steps>
  ...
  <Step title="Copy the source URL">
    ...
    <Image
      src="/images/integrations/sources/clay/copy-source-url.png"
...
<Steps>
  <Step title="Add an HTTP API enrichment column">
    ...
    <Image
      ...
      alt="The Clay HTTP API enrichment column configuration with the Knock source URL as the POST destination"
      width={2964}
      height={1842}
    />
