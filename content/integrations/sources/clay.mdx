...
<Steps>
  <Step title="Add an HTTP API enrichment column">
    ...
    <Image
          src="/images/integrations/sources/clay/clay-data-source-http-api.png"
          width={1000}
          height={500}
          alt="Adding an HTTP API column in Clay"
        />

  </Step>
  <Step title="Add the Authorization header">
    In the **Accounts** section, add a HTTP API (Headers) account with key `Authorization` and value `Bearer <your-signing-secret>`, replacing `<your-signing-secret>` with the value you set in Knock. Knock uses this Bearer token to verify each POST from your Clay table before processing the row data.
    <Image
          src="/images/integrations/sources/clay/clay-data-source-header-account.png"
          width={1000}
          height={500}
          alt="Adding the Authorization header in Clay"
        />
  </Step>
  ...
  <Step title="Run the enrichment column">
    ...
    <Image
          src="/images/integrations/sources/clay/clay-data-source-run.png"
          width={1000}
          height={500}
          alt="Adding the Authorization header in Clay"
        />
