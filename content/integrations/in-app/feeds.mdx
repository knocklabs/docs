...
<AccordionGroup>
  <Accordion title="The buttons on the in-app feed preview in my dashboard don't use my configured brand colors. Can I style the buttons in my in-app feed?" anchorSlug="faq-styling-in-app-feed-buttons">
