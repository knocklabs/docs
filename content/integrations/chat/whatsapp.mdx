...
Next, <a href="https://developers.facebook.com/docs/whatsapp/cloud-api/get-started/add-a-phone-number" target="_blank" rel="noopener">add a business phone number</a> to send messages from. You can do this using the _Add Phone Number_ button which is below the current page.
