...
First you'll need to add Teams as a channel in Knock. Navigate to the "Integrations" page and “Channels” tab within Knock and click “Create channel” to add Microsoft Teams.
