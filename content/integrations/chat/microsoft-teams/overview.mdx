...
<Steps>
  ...
  <Step title="Select your bot’s type">
    Before choosing a bot type in Knock, you'll first want to confirm how your bot is registered in Azure. You can locate both the Bot Type and App (Entra) Tenant ID in the <a href="https://portal.azure.com/" target="_blank">Azure Portal</a> by
    ...
    <AccordionGroup>
      ...
      <Accordion title="Multi-tenant bot">
