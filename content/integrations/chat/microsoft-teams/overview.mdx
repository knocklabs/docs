...
<Callout
  ...
  text={
    <>
      ...
      multi-tenant bots. However, if you are setting up a new Microsoft Teams
      integration, you should register your bot as single-tenant and publish it
      to the Teams app store so that it can be installed across customer
      workspaces.
    </>
  }
/>
