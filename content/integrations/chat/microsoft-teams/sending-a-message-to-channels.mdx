...
- Setting required Tenant and Object channel data when a Microsoft Teams bot is installed in a user's personal scope
...
There are two key concepts you'll see throughout the following docs that are foundational to how Knock's Microsoft Teams integration works, but might not be used in every implementation of Knock: tenants and objects.
