...
- **Tenant-scoped connections.** Route the same recipient to different Slack, Microsoft Teams, or Discord destinations based on the [tenant in the workflow trigger](/managing-recipients/setting-channel-data#scope-chat-connections-by-tenant).
