...
description: "Learn how to implement Slack direct messaging in Knock, including user authentication, email-to-ID resolution, and sending personalized DM notifications."
tags: ["slack", "chat"]
