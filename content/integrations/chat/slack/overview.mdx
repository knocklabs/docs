...
<Callout
  ...
  text={
    <>
      ...
      <a href="https://api.slack.com/reference/surfaces/formatting#basics" target="_blank">
        mrkdwn
      </a>
      , but Knock handles this for you automatically, so you can write your templates
      in good old <a href="https://daringfireball.net/projects/markdown/" target="_blank">
        {" "}
        markdown
      </a>.
    </>
