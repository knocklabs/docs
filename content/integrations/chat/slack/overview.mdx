...
- Using Knock's managed approach with our [SlackKit components](/integrations/chat/slack/overview)
- Using Knock's [Slack-related React hooks](/integrations/chat/slack/overview) with your own components
...
| connections | `SlackConnection[]` | One or more connections to Slack |
    ...
    We cover Slack app scopes in detail in our [Slack scopes guide](/integrations/chat/slack/overview).
