...
<Callout
  ...
  text={
    <>
      <span className="font-bold">Note:</span> You can support these use cases using either standard Slack OAuth or through the <code>incoming-webhook</code> scope that we describe <a href="/integrations/chat/slack-diy/slack-apps-and-scopes">here</a>. In the examples below we use <code>incoming-webhook</code> to keep things simple.
    </>
  }
/>
