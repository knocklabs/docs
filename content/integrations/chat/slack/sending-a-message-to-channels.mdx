...
description: "Configure Slack channel notifications in Knock to send messages to public and private channels, with channel selection and multi-channel routing capabilities."
tags: ["slack", "chat"]
