...
In Knock, we model channels in a Slack workspace as connections on objects. [Objects](/concepts/objects) allow you to model any resource in your system within Knock and their primary purpose is to act as non-user recipients, but are very flexible abstractions.
