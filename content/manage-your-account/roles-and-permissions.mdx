  ...
  rowGroups={[
    {
      ...
      rows: [
        ...
        { name: "View account members", columnsYes: ["Owner", "Admin"] },
        { name: "Manage account members", columnsYes: ["Owner", "Admin"] },
        {
    ...
    },
    {
      ...
      rows: [
        {
          name: "View content resources (workflows, guides, broadcasts, layouts, partials, message types, translations, reusable requests, and assets)",
