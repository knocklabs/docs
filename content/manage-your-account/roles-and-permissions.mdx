  ...
  rowGroups={[
    {
      ...
      rows: [
        ...
        {
          name: "Create and manage permission groups",
          columnsYes: ["Owner", "Admin"],
        },
    ...
    },
    {
      ...
      rows: [
        {
          name: "View workflows and content resources",
        ...
        {
          name: "Run and test workflows",
          columnsYes: ["Owner", "Admin", "Member", "Prod Member"],
        },
        {
          name: "Create and manage guides",
          columnsYes: ["Owner", "Admin", "Member", "Prod Member"],
        },
        {
          name: "Create and manage broadcasts",
          columnsYes: ["Owner", "Admin", "Member", "Prod Member"],
        },
        {
          name: "Create and manage goals",
          columnsYes: ["Owner", "Admin", "Member", "Prod Member"],
        },
        {
        ...
        {
          name: "Create and manage partials",
          columnsYes: ["Owner", "Admin", "Member", "Prod Member"],
        },
        {
          name: "Create and manage message types",
          columnsYes: ["Owner", "Admin", "Member", "Prod Member"],
        },
        {
          name: "Create and manage translations",
          columnsYes: ["Owner", "Admin", "Member", "Prod Member"],
        },
        {
          name: "Create and manage reusable steps",
          columnsYes: ["Owner", "Admin", "Member", "Prod Member"],
        },
        {
        ...
        {
          name: "Create and manage branches",
    ...
    },
    {
      ...
      rows: [
        ...
        {
          name: "Create and manage audiences",
          columnsYes: ["Owner", "Admin", "Member", "Prod Member"],
        },
        {
        ...
        {
          name: "Create and manage schemas",
          columnsYes: ["Owner", "Admin"],
        },
      ],
    },
    ...
    },
    {
      ...
      rows: [
        ...
        { name: "Create and manage channels", columnsYes: ["Owner", "Admin"] },
        {
          name: "View sources",
          columnsYes: ["Owner", "Admin", "Member", "Prod Member"],
        },
        { name: "Create and manage sources", columnsYes: ["Owner", "Admin"] },
        {
        ...
        {
          name: "Use the AI agent and manage agent skills",
          columnsYes: ["Owner", "Admin", "Member", "Prod Member"],
        },
      ],
    },
