  ...
  rowGroups={[
    {
      name: "Admin",
      rows: [
        { name: "Manage billing", columnsChecked: ["Owner", "Billing"] },
        {
          name: "Create and manage environments",
          columnsChecked: ["Owner", "Admin"],
        },
        { name: "View account audit logs", columnsChecked: ["Owner", "Admin"] },
        {
          name: "Invite and manage account members",
          columnsChecked: ["Owner", "Admin"],
        },
        { name: "Manage account branding", columnsChecked: ["Owner", "Admin"] },
      ],
    },
    {
      name: "Core",
      rows: [
        {
          ...
          columnsChecked: ["Owner", "Admin", "Member"],
        },
        {
        ...
        },
        {
          ...
          columnsChecked: ["Owner", "Admin", "Member", "Support"],
        },
        {
    ...
    },
    {
      name: "Developer",
      rows: [
        { name: "View API keys", columnsChecked: ["Owner", "Admin", "Member"] },
        { name: "Roll API keys", columnsChecked: ["Owner", "Admin"] },
        { name: "Manage variables", columnsChecked: ["Owner", "Admin"] },
        { name: "Manage signing keys", columnsChecked: ["Owner", "Admin"] },
        { name: "Manage webhooks", columnsChecked: ["Owner", "Admin"] },
      ],
    },
  ]}
/>
