...
3. Follow the step-by-step instructions in the provided guide to complete the configuration.
...
Once the setup is complete and user data starts syncing successfully from your identity provider to Knock, you'll see a "connected" status for directory sync under **Settings** > **General**.
