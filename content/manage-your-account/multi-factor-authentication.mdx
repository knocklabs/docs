...
<AccordionGroup>
  <Accordion
    title="What authenticator apps are supported?"
    anchorSlug="faq-supported-authenticator-apps"
  >
  ...
  <Accordion
    title="What devices and browsers support passkeys?"
    anchorSlug="faq-passkey-device-browser-support"
  >
  ...
  <Accordion
    title="Can I enroll both an authenticator app and a passkey?"
    anchorSlug="faq-authenticator-app-and-passkey"
  >
  ...
  <Accordion title="Can I remove a passkey?" anchorSlug="faq-remove-passkey">
    Yes. You can remove individual passkeys from your profile **Security**
    settings at any time.
  </Accordion>
  <Accordion
    title="Can I disable MFA on my account?"
    anchorSlug="faq-disable-mfa"
  >
  ...
  <Accordion
    title="What happens if I lose my authenticator and backup codes?"
    anchorSlug="faq-lost-authenticator-and-backup-codes"
  >
    Contact an account owner or admin to reset your MFA. After the reset, you
    enroll a new MFA method at your next login.
  </Accordion>
  <Accordion
    title="What happens if I lose access to my passkey?"
    anchorSlug="faq-lost-passkey-access"
  >
    Contact an account owner or admin to reset your MFA. After the reset, you
    enroll a new MFA method at your next login.
  </Accordion>
  <Accordion
    title="Does MFA apply to API keys or service tokens?"
    anchorSlug="faq-mfa-for-api-keys-and-service-tokens"
  >
