...
<AccordionGroup>
  <Accordion
    title="I've added the CNAME record successfully. Why isn't my domain marked as verified?"
    anchorSlug="faq-cname-added-domain-not-verified"
  >
  ...
  <Accordion
    title="Can I use a brand new domain?"
    anchorSlug="faq-brand-new-domain"
  >
  ...
  <Accordion
    title="Will URLs in already-sent messages stop working after I set a custom domain?"
    anchorSlug="faq-sent-message-urls-after-custom-domain"
  >
  ...
  <Accordion
    title="Will URLs stop working if I unassign my custom domain from an environment or feature?"
    anchorSlug="faq-urls-after-unassigning-custom-domain"
  >
  ...
  <Accordion
    title="Can I switch from one custom domain to another?"
    anchorSlug="faq-switching-custom-domains"
  >
  ...
  <Accordion
    title="Does a preference center custom domain affect commercial unsubscribe links?"
    anchorSlug="faq-preference-center-domain-unsubscribe-links"
  >
