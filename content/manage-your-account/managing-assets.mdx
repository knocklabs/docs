...
<AccordionGroup>
  <Accordion
    ...
    anchorSlug="faq-supported-file-types"
  >
  ...
  <Accordion
    title="Is there a limit to how many assets I can upload?"
    anchorSlug="faq-asset-upload-limit"
  >
  ...
  <Accordion
    ...
    anchorSlug="faq-maximum-file-size"
  >
    Each image file must be 2 MB or less.
  </Accordion>
  <Accordion
    title="Who can upload and manage assets?"
    anchorSlug="faq-who-can-manage-assets"
  >
