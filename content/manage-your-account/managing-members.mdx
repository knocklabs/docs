...
<Callout
  ...
  text={
    <>
      Only account owners and admins can view, manage, and invite new members to
      your account.
    </>
  }
/>
...
You can manage the members of your account on the **Members** page under the **Admin** section of your account settings in your Knock dashboard:
...
On the members page, members with appropriate [permissions](/manage-your-account/roles-and-permissions) can remove other members from an account by clicking the "Remove member" option found in the three dot menu. Removing a member will revoke their access to Knock and immediately invalidate any session associated with the user. The member will receive an email informing them of the change in account access.
