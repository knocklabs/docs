...
<Attributes>
  ...
  <Attribute
    name="tenantId*"
    type="string"
    description="The ID of the Knock tenant that will be storing the Microsoft Teams tenant ID"
  />
</Attributes>
...
<Attributes>
  ...
  <Attribute
    ...
    type="function"
    description="Function to disconnect from Microsoft Teams which removes the Microsoft Teams tenant ID from the tenant in Knock"
  />
</Attributes>
