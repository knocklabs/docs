...
<Table
  headers={["Scale", "Limit"]}
  rows={[
    [<RateLimit tier={1} />, "1 request / second"],
    [<RateLimit tier={2} />, "5 requests / second"],
    [<RateLimit tier={3} />, "60 requests / second"],
    [<RateLimit tier={4} />, "200 requests / second"],
    [<RateLimit tier={5} />, "1,000 requests / second"],
  ]}
/>
...
<Table
  headers={["Scale", "Limit"]}
  rows={[[<RateLimit isBatch tier={1} />, "1 update / second / entity"]]}
/>
...
- [Bulk identify users](/api-reference/users#bulk-identify-users) - Identify multiple users in a single operation (up to 1,000 users)
- [Bulk delete users](/api-reference/users#bulk-delete-users) - Permanently delete up to 1,000 users at a time
- [Bulk set user preferences](/api-reference/users#bulk-set-preferences) - Set preferences for up to 1,000 users at a time

**Objects**

- [Bulk set objects](/api-reference/objects#bulk-set-objects) - Set up to 1,000 objects at a time in a specified collection
- [Bulk delete objects](/api-reference/objects#bulk-delete-objects) - Delete objects from a specified collection
- [Bulk add object subscriptions](/api-reference/objects#bulk-add-subscriptions) - Add subscriptions for all objects in a single collection
- [Bulk delete object subscriptions](/api-reference/objects#bulk-delete-subscriptions) - Delete subscriptions for many objects in a single collection

**Tenants**

- [Bulk set tenants](/api-reference/tenants#bulk-set-tenants) - Set or update up to 1,000 tenants in a single operation
- [Bulk delete tenants](/api-reference/tenants#bulk-delete-tenants) - Delete up to 1,000 tenants at a time

**Schedules**

- [Bulk create schedules](/api-reference/schedules#bulk-create-schedules) - Create up to 1,000 schedules at a time

**Messages**

- [Bulk update message statuses for channel](/api-reference/channels#bulk-update-messages-for-channel) - Bulk update the status of messages for a specific channel
...
<ErrorExample
  ...
  description="Your API key has expired. You can regenerate one on the API keys page of the Knock dashboard."
/>
