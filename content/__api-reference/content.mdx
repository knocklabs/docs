...
- [Bulk identify users](/api-reference/users#bulk-identify-users)
- [Bulk delete users](/api-reference/users#bulk-delete-users)
- [Bulk set user preferences](/api-reference/users#bulk-set-preferences)

**Objects**

- [Bulk set objects](/api-reference/objects#bulk-set-objects)
- [Bulk delete objects](/api-reference/objects#bulk-delete-objects)
- [Bulk add object subscriptions](/api-reference/objects#bulk-add-subscriptions)
- [Bulk delete object subscriptions](/api-reference/objects#bulk-delete-subscriptions)

**Tenants**

- [Bulk set tenants](/api-reference/tenants#bulk-set-tenants)
- [Bulk delete tenants](/api-reference/tenants#bulk-delete-tenants)

**Schedules**

- [Bulk create schedules](/api-reference/schedules#bulk-create-schedules)

**Messages**

- [Bulk update message statuses for channel](/api-reference/channels#bulk-update-messages-for-channel)
