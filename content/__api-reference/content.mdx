...
You can view and manage your API keys in the Developer Dashboard. You can create any number of API keys per environment, and there are two types of keys:
