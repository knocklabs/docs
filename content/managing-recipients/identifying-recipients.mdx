...
| `timezone`     | A valid <a href="https://en.wikipedia.org/wiki/List_of_tz_database_time_zones" target="_blank" rel="noopener noreferrer">tz database time zone string</a> used for [send windows](/designing-workflows/send-windows) and [schedules](/concepts/schedules). |
