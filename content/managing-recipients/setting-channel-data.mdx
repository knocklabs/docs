...
description: Configure channel-specific delivery information for recipients to enable push notifications and chat messages across multiple platforms.
...
- Setting channel data always requires a `channel_id`, which can be obtained in the Dashboard under **Integrations** and **Channels**. A channel ID is always a UUID v4.
