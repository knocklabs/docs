...
<Image
  ...
  alt="The Knock agent conversation history and prompt interface in the dashboard UI"
  width={1366}
  height={888}
  className="mx-auto"
/>
...
<AccordionGroup>
  <Accordion
    title="Does the Knock agent use my AI credits?"
    anchorSlug="faq-knock-agent-ai-credits"
  >
  ...
  <Accordion
    title="Can I use the MCP server from my IDE instead?"
    anchorSlug="faq-mcp-server-from-ide"
  >
    Yes. See the <a href="/ai/mcp-server">MCP server</a> docs for authentication
    and tool groups.
  </Accordion>
</AccordionGroup>
