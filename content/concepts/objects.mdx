...
<Callout
  ...
  text={
    <>
      Referencing object data via Liquid is currently in beta. If you'd like
      early access, or this is blocking your adoption of Knock, please{" "}
      <a href="mailto:support@knock.app?subject=Referencing%20entity%20data%20via%20Liquid">
        get in touch
      </a>
      .
    </>
