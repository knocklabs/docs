...
<AccordionGroup>
  <Accordion title="Set individual objects" anchorSlug="set-individual-objects">
  ...
  <Accordion title="Bulk set objects" anchorSlug="bulk-set-objects">
  ...
  <Accordion title="Set objects inline" anchorSlug="set-objects-inline">
