...
<Callout
  ...
  text={
    <>
      In Knock's Python SDK v1.0+, the optional <code>name</code> property and any custom properties provided must be passed in via the <code>extra_body</code> parameter. See the <a href="https://github.com/knocklabs/knock-python" target="_blank" rel="noopener">Python SDK documentation</a> for details.
