...
<Callout
  ...
  text={
    <>
      ...
      <a href="/concepts/objects#sending-object-data-to-knock">Object</a> in a
      special-system defined collection, <code>$tenants</code>. That means that
      anything you can do on an object you can do on a tenant.
    </>
  }
/>
