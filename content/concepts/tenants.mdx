...
- Is uniquely identified by an `id`, [per-environment](/concepts/variables). In most cases, this `id` is the same `uuid` used to identify the tenant in your system
...
<Callout
  ...
  text={
    <>
      ...
      <a href="/concepts/objects#sending-object-data-to-knock">Object</a> in a special-system defined collection,{" "}
      <code>$tenants</code>. That means that anything you can do on an object you can do on a tenant.
    </>
  }
/>
