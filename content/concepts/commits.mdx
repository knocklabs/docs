...
<Callout emoji={"🚨"}>
**Note**: you can only revert a commit in the development environment. If you need to revert a change to a higher environment, you must first revert it in development and then promote the revert commit.
</Callout>
