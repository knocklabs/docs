...
You can reorder your custom environments (any environment other than Development and Production) to match your team's workflow preferences. To reorder environments, go to **Settings** > **Environments** and use the drag-and-drop interface to arrange your environments in the desired order.

Note that Development and Production environments are fixed at the beginning and end of your environment chain, respectively.
