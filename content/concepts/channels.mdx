...
You can create and manage channels within Knock from the dashboard under the **Integrations** > **Channels** section of your account settings. A created channel exists across all environments in your Knock account and uses the same ID for each environment.
