...
Because parsing happens before your templates and conditions run, compare a variable against the type it parses into. A variable set to `true` is a boolean, so compare it as one:
