...
3. [**Preference conditions**](/concepts/preferences#preference-conditions) — Used to determine the complete set of preferences available to the current workflow run. For example, allow a recipient to mute notifications for specific resources in your product.
...
- **Environment variable** — Evaluates against one of your [environment variables](/concepts/environments#account-and-environment-variables).
