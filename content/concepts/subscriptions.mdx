...
Note: for all of the examples below you will need to have an [object identified within Knock](/concepts/objects#1-set-individual-objects). In our examples below, we create an object under a `project_alerts` collection with an id `project-1`.
