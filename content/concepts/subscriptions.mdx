...
<AccordionGroup>
  <Accordion
    title="What's the maximum number of subscribers I can have against an object?"
    anchorSlug="faq-max-subscribers-per-object"
  >
  ...
  <Accordion
    title="Can I have nested relationships for my objects?"
    anchorSlug="faq-nested-object-relationships"
  >
  ...
  <Accordion
    title="Can I manage subscribers to an object in the dashboard?"
    anchorSlug="faq-manage-subscribers-in-dashboard"
  >
    Right now, you can only **view** the subscribers of an object in the
    dashboard. You can do so under **Objects** > **Subscriptions**.
  </Accordion>
  <Accordion
    title="Can I set custom properties on a Subscription?"
    anchorSlug="faq-subscription-custom-properties"
  >
    Yes, you can pass a set of `properties`, which is a set of unstructured
    key-value pairs that you set any arbitrary data about.
  </Accordion>
  <Accordion
    title="Can I filter the set of Subscriptions to be notified?"
    anchorSlug="faq-filter-subscriptions-to-notify"
  >
  ...
  <Accordion
    title="Can I still debug workflow runs for the subscribers of an object?"
    anchorSlug="faq-debug-subscriber-workflow-runs"
  >
  ...
  <Accordion
    title="Can I notify both the object AND the subscribers of the object?"
    anchorSlug="faq-notify-object-and-subscribers"
  >
  ...
  <Accordion
    title="Can I skip the workflow run generated for the object itself?"
    anchorSlug="faq-skip-object-workflow-run"
  >
  ...
  <Accordion
    title="Can I notify a recipient each time they appear within an object subscription tree?"
    anchorSlug="faq-duplicate-notifications-subscription-tree"
  >
  ...
  <Accordion
    title="Is the object that recipients are subscribed to exposed in the workflow run scope?"
    anchorSlug="faq-object-in-workflow-run-scope"
  >
    Yes. You can access the object that the recipient is subscribed to using the
    `recipient.subscription.object` property.
  </Accordion>
  <Accordion
    title="Are subscription properties refreshed when a paused workflow run resumes?"
    anchorSlug="faq-subscription-properties-on-paused-runs"
  >
  ...
  <Accordion
    title="Will the actor included in the workflow trigger receive a notification if they are a subscriber?"
    anchorSlug="faq-actor-as-subscriber-notification"
  >
  ...
  <Accordion
    title="Can I create a schedule to notify subscribers of an object?"
    anchorSlug="faq-schedule-for-object-subscribers"
  >
  ...
  <Accordion
    title="Can I cancel a workflow run for a specific recipient if they were notified via an object subscription?"
    anchorSlug="faq-cancel-run-for-subscribed-recipient"
  >
