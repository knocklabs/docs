...
<Callout
  ...
  text={
    <>
      <span className="font-bold">Note:</span> if you're looking to send a
      one-time message to a set of recipients, you should use a <a href="/concepts/broadcasts">broadcast</a> instead.
    </>
  }
/>
