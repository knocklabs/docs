...
<Callout
  type="info"
  title="Editing workflows across environments"
  text={
    <>
      By default, workflows can only be edited in development and must be{" "}
      <a href="/version-control/commits#promoting-commits">
        promoted to production
      </a>
      . If your account has <a href="/version-control/environments#production-write-access">
        production write access
      </a> enabled, workflows can be edited in the environment where they were created
      (their origin environment). Learn more about <a href="/version-control/commits#origin-environment-and-editing-restrictions">
        origin environment restrictions
      </a>.
    </>
  }
/>
...
All changes to workflows, including changes made to the templates inside of a workflow, are version controlled. By default, changes must be made in the development environment and then "committed" and "promoted" between environments. If your account has [production write access](/version-control/environments#production-write-access) enabled, workflows can be edited in their [origin environment](/version-control/commits#origin-environment-and-editing-restrictions) (the environment where they were created). This allows you to confidently make changes to workflows while maintaining appropriate controls.
...
You can learn more about automating workflow management in the [Knock CLI reference](/cli/overview). Feel free to <a href="mailto:support@knock.app">contact us</a> if you have questions.
