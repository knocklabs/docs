...
- orchestrate branch and conditional logic within your workflows (e.g. if a user is in a `paid users` audience, opt them out of the workflow)
...
Create or open the workflow you’d like to trigger for your audience, then open the step editor. Click on the “Trigger” step, then click “Edit trigger type” in the top right corner. Click “Audience“ and then select the audience you’d like this workflow to trigger from.
