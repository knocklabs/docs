...
<AccordionGroup>
  <Accordion title="What happens if my audience contains a 'missing user' who I subsequently identify to Knock?" anchorSlug="faq-audience-missing-user-identified">
  ...
  <Accordion title="Can I create a dynamic audience from user data in Knock?" anchorSlug="faq-dynamic-audience-from-user-data">
  ...
  <Accordion title="Can I use source event data to build a dynamic audience?" anchorSlug="faq-dynamic-audience-source-event-data">
  ...
  <Accordion title="Can I use tenant or other object data to build a dynamic audience?" anchorSlug="faq-dynamic-audience-tenant-object-data">
  ...
  <Accordion title="How quickly are dynamic audiences updated?" anchorSlug="faq-dynamic-audience-update-speed">
  ...
  <Accordion title="Can I use audiences on a branch?" anchorSlug="faq-audiences-on-branch">
  ...
  <Accordion title="Are all user properties available in the audience builder?" anchorSlug="faq-user-properties-in-audience-builder">
  ...
  <Accordion title="How can I remove users from a static audience?" anchorSlug="faq-remove-users-from-static-audience">
