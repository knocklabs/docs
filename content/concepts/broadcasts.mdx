...
- [Random cohort branch functions](/designing-workflows/random-cohort-branch-function): to randomly assign recipients to percentage-based cohorts for A/B testing and experimentation.
