...
Broadcasts produce messages, exactly as workflows do. As such, messages sent as part of a broadcast will be visible in the **Analytics** page within the Knock dashboard. Each sent broadcast also has its own **Analytics** tab with run, delivery, and engagement metrics for the broadcast and each of its steps. See [workflow analytics](/send-notifications/analytics#workflow-analytics) for details. Additionally, broadcast engagement metrics are available in any [connected data warehouses](/integrations/extensions/data-sync).
...
<AccordionGroup>
  <Accordion
    title="Who can create and send broadcasts?"
    anchorSlug="faq-broadcast-permissions"
  >
  ...
  <Accordion
    title="Can I call a broadcast via the API?"
    anchorSlug="faq-broadcast-via-api"
  >
    No, broadcasts are not callable via the API.
  </Accordion>
  <Accordion
    title="Can I work with broadcasts in the Knock CLI?"
    anchorSlug="faq-broadcasts-in-knock-cli"
  >
    No, currently broadcasts cannot be managed via the Knock CLI.
  </Accordion>
  <Accordion
    title="Can I send a broadcast to a set of objects?"
    anchorSlug="faq-broadcast-to-objects"
  >
  ...
  <Accordion
    title="Can I send a broadcast to a set of users who don't exist in Knock?"
    anchorSlug="faq-broadcast-to-nonexistent-users"
  >
  ...
  <Accordion
    title="What's the maximum size of a CSV upload for a broadcast?"
    anchorSlug="faq-max-csv-upload-size"
  >
