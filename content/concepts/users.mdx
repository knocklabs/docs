...
**How can I update a user's information?**

If you need to edit or update a user's information in Knock, you can either use the [identify a user endpoint](https://docs.knock.app/reference#identify-user) or [inline identification](https://docs.knock.app/managing-recipients/identifying-recipients#inline-identifying-recipients) when triggering a workflow.
