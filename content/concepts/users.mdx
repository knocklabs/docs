...
| phone_number | The <a href="https://www.twilio.com/docs/glossary/what-e164" target="_blank" rel="noopener">E.164</a> phone number of the user (required for SMS channels)                                                                                                                       |
| timezone     | A valid <a href="https://en.wikipedia.org/wiki/List_of_tz_database_time_zones" target="_blank" rel="noopener noreferrer">tz database time zone string</a> (optional for [recurring schedules](/concepts/schedules#scheduling-workflows-with-recurring-schedules-for-recipients)) |
