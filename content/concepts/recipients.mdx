...
<AccordionGroup>
  <Accordion
    title="Is there a limit on the number of recipients I can have in Knock?"
    anchorSlug="faq-recipient-limit"
  >
    No, there's no limit on the number of recipients you can have within Knock.
  </Accordion>
  <Accordion
    title="Why would I need a non-user recipient?"
    anchorSlug="faq-non-user-recipients"
  >
  ...
  <Accordion
    title="Is there a limit to the size of the properties I can pass on a recipient to Knock?"
    anchorSlug="faq-recipient-property-size-limit"
  >
