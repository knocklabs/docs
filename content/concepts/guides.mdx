...
- **Seen**: The number of guides that were seen by the recipient at least once.
- **Interacted**: The number of guides that were interacted with (e.g. the recipient clicked a link).
- **Archived**: The number of guides that were archived.
