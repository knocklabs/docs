...
Goals are measurable outcomes you define in Knock, such as a user activating or converting to a paid plan. You attach goals to workflows, broadcasts, and guides to track completions against a designated outcome.
