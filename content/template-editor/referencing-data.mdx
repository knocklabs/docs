...
<AccordionGroup>
  <Accordion title="What happens if I reference a user, object, or tenant that doesn't exist?" anchorSlug="faq-missing-user-object-or-tenant">
  ...
  <Accordion title="How can I ensure that only certain users, objects, or tenants are available in my template?" anchorSlug="faq-restrict-template-data-access">
