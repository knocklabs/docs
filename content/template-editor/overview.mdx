...
The Knock template editor uses Liquid tags to create the logic and control flow for notification templates. To learn more about Liquid, you can check out <a href="https://shopify.github.io/liquid/basics/introduction/" target="_blank">their documentation.</a>
...
<AccordionGroup>
  <Accordion title="Why store all of my notification templates in Knock?" anchorSlug="faq-storing-templates-in-knock">
