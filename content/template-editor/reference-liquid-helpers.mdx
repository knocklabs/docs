...
<AccordionGroup>
  <Accordion title="`timezone`" anchorSlug="timezone">
  ...
  <Accordion title="`date`" anchorSlug="date">
  ...
  <Accordion title="`format_date_in_locale`" anchorSlug="format_date_in_locale">
  ...
  <Accordion title="`format_datetime_in_locale`" anchorSlug="format_datetime_in_locale">
...
<AccordionGroup>
  ...
  <Accordion title="`currency`" anchorSlug="currency">
  ...
  <Accordion title="`rounded_currency`" anchorSlug="rounded_currency">
...
<AccordionGroup>
  <Accordion title="`json`" anchorSlug="json">
  ...
  <Accordion title="`from_json`" anchorSlug="from_json">
  ...
  <Accordion title="`pluralize`" anchorSlug="pluralize">
  ...
  <Accordion title="`titlecase`" anchorSlug="titlecase">
  ...
  <Accordion title="`from_markdown`" anchorSlug="from_markdown">
   ...
   <Accordion title="`intersect`" anchorSlug="intersect">
  ...
  <Accordion title="`compare_versions`" anchorSlug="compare_versions">
...
<AccordionGroup>
  <Accordion title="`md5`" anchorSlug="md5">
  ...
  <Accordion title="`sha256`" anchorSlug="sha256">
  ...
  <Accordion title="`hmac_sha256`" anchorSlug="hmac_sha256">
