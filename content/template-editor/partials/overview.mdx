...
<AccordionGroup>
  <Accordion title="Why can't I see my partial in the editor or preview?" anchorSlug="faq-partial-not-visible-in-editor">
  ...
  <Accordion title="I want to use structured JSON from my trigger data in my partial. How can I reference an object or array in a partial?" anchorSlug="faq-reference-json-objects-in-partials">
  ...
  <Accordion title="Can I use dynamic boolean values from my trigger data in a partial?" anchorSlug="faq-dynamic-boolean-values-in-partials">
  ...
  <Accordion title="Can I reference template editor variables like `recipient`, `current_message`, or `workflow` within a partial's content?" anchorSlug="faq-template-editor-variables-in-partials">
