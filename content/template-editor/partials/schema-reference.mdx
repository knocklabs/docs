...
<Table
  ...
  rows={[
    ...
    ["Markdown", "Markdown-formatted text input that supports formatting syntax."],
    ["Textarea", "Multi-line text input field for longer content."],
    ["Boolean", "True/false checkbox or toggle field."],
    ["Select", "Dropdown selection field for choosing a single option. Useful for expressing enums."],
    ["Multi-select", "Dropdown selection field for choosing multiple options."],
    ["Button", "Button configuration field for text, link, and styling options."],
