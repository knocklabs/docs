...
<Table
  ...
  rows={[
    ...
    [
      "Number",
      "Numeric input field with optional min/max bounds and a unit label.",
    ],
    ["Color", "Hex color input field (#RGB or #RRGGBB)."],
    [
      "Select",
    ...
    ["JSON", "JSON input field with schema validation."],
    [
      "List",
      "List of items, with an optional JSON schema validating the structure of each item.",
    ],
  ]}
/>
...
<Attributes>
  ...
  <Attribute
    name="schema"
    type="object"
    description="A [JSON Schema](https://json-schema.org/) object that validates the expected structure of the input. Supports `properties` to define the expected keys and their types, and `required` to specify which keys must be present."
  />
</Attributes>
...
A list of items, with an optional [JSON Schema](https://json-schema.org/) that validates the structure of each item in the list.
...
<Attributes>
  ...
  <Attribute
    name="itemSchema"
    type="object"
    description="A [JSON Schema](https://json-schema.org/) object that validates the structure of each item in the list."
  />
</Attributes>
...
<AccordionGroup>
  <Accordion title="What should I know about using default schema values in Liquid conditions?">
