...
Admin users can set branding for an account via the dashboard under the **Settings** > **Branding** page. From here, you can set the logo, icon, primary color, and primary contrast color.
