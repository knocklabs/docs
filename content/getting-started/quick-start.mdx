...
<Steps titleSize="h2">
  ...
  <Step title="Publish to production">
    Knock uses [logically separated environments](/concepts/overview#environments) to control the roll-out of your notifications. When you're happy with the way your workflows work and look, you just need to promote them to production to start sending notifications to your real users.
  ...
  <Step title="Go deeper">
    ...
    - [Learn about Knock's core data concepts](/concepts)
