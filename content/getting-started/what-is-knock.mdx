---
title: What is Knock?
description: Discover how Knock's notification infrastructure helps you build, manage, and deliver notifications across multiple channels using workflows and templates.
