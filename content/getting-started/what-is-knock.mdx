...
- Creating advanced notification logic using [subscriptions](/concepts/subscriptions) and [schedules](/concepts/overview#schedules)
- Integrating Knock with your application's data model, using [tenants](/concepts/tenants) and [objects](/concepts/overview#objects) to power customized experiences
...
Knock is a developer-first platform, with both [environment](/concepts/environments) and [commit models](/concepts/overview#commits). If you want to work with Knock resources in code, you can use our [Management API](/developer-tools/management-api) or [CLI](/developer-tools/knock-cli).
