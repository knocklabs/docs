...
<Steps titleSize="h2">
  <Step title="Create a Knock account">
    First, <a href="https://dashboard.knock.app/signup" target="_blank" rel="noopener">create a Knock account</a> if you don't already have one and log into the <a href="https://dashboard.knock.app" target="_blank" rel="noopener">Knock dashboard</a>.
  </Step>
  <Step title="Create a new React application">
    Run the following command to <a href="https://react.dev/learn/build-a-react-app-from-scratch#vite" target="_blank" rel="noopener noreferrer">create a new React application</a>.
...
```
  ...
  <Step title="Create a workflow in Knock">
    ...
    <AccordionGroup>
      <Accordion title="Create a workflow" anchorSlug="create-a-workflow">
      ...
      <Accordion title="Add an in-app channel step" anchorSlug="add-an-in-app-channel-step">
      ...
      <Accordion title="Design the notification message" anchorSlug="design-the-notification-message">
      ...
      <Accordion title="Commit the workflow to development" anchorSlug="commit-the-workflow-to-development">
...
<ResponsiveTwoColumn pr="6" pb="6">
  <ContentCard
    title="Overview"
    description="See how Knock AI fits together across surfaces."
    href="/ai/overview"
  />
  <ContentCard
    title="Skills"
    description="Procedural knowledge for agents working with Knock."
    href="/ai/skills"
  />
  <ContentCard
    title="MCP server"
    description="Give agents tools to read and write Knock resources."
    href="/ai/mcp-server"
  />
  <ContentCard
    title="Knock agent"
    description="Use the in-dashboard agent to build and manage Knock."
    href="/ai/agent"
  />
  <ContentCard
    title="Agent function"
    description="Run AI enrichment and personalization inside workflows."
    href="/ai/agent-function"
  />
  <ContentCard
    title="Knock CLI"
    description="Local-first tools for agents working in your codebase."
    href="/ai/cli"
  />
</ResponsiveTwoColumn>
