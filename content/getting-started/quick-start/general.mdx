...
Prefer a guided setup? Open the Knock agent in your dashboard to walk through creating and triggering your first workflow.

<AgentDeeplinkButton prompt="Help me create and trigger my first Knock workflow" />
