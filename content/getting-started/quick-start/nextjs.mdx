...
```
    ...
    With the server started, you can click the **Trigger Workflow** button and the applciation will run the `triggerWorkflow` server action and produce a notification in the feed.
