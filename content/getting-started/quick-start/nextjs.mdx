...
<Steps titleSize="h2">
  ...
  <Step title="Create a new Next.js application">
    Run the following command to <a href="https://nextjs.org/docs/app/getting-started/installation" target="_blank" rel="noopener noreferrer">create a new Next.js application</a>.
