...
<AccordionGroup>
  <Accordion
    title="Use the workflow description to add additional calling context for the LLM"
    anchorSlug="workflow-description-calling-context"
  >
  ...
  <Accordion
    title="Limit the workflows that are exposed to the LLM"
    anchorSlug="limit-the-workflows-that-are-exposed-to-the-llm"
  >
  ...
  <Accordion
    title="Ensure your trigger data JSON schema has good descriptions"
    anchorSlug="trigger-data-schema-descriptions"
  >
  ...
  <Accordion
    title="Keep your trigger data JSON schema as simple as possible"
    anchorSlug="simple-trigger-data-schema"
  >
