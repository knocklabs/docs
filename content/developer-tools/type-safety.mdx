...
Before you can generate types for your workflow triggers, you need to define a <a href="https://json-schema.org/" target="_blank" rel="noopener noreferrer">JSON schema</a> that describes the expected structure of the data passed to your workflow, which we call a [trigger data schema](/designing-workflows/validating-trigger-data). This schema serves as the source of truth for type generation.
