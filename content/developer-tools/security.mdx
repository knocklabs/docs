...
Below you can learn more about our security credentials, our internal security practices, and how to disclose security issues to our team. If you're looking to learn more about how we think about data privacy at Knock, you can read our <a href="https://knock.app/legal/privacy-policy" target="_blank" rel="noopener">privacy policy</a>.

## Our security posture

Knock is SOC 2 Type 2 compliant, GDPR certified, CCPA, and HIPAA compliant. We perform regular penetration tests. If you'd like copies of our SOC 2 report or penetration test report, please let us know at [security@knock.app](mailto:security@knock.app). You can learn more about our GDPR certification in our <a href="https://knock.app/legal/privacy-policy" target="_blank" rel="noopener">privacy policy</a>.
