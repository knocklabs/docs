...
<Callout
  ...
  text={
    <>
      The <code>event_data</code> field is event type specific. Most message
      events return <code>null</code> for <code>event_data</code> - only the
      events documented below include additional data in this field.
    </>
  }
/>
