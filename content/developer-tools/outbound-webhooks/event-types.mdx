...
## Source workflow trigger events

### `source_workflow_trigger.updated`

Occurs whenever a source workflow trigger is updated in the environment.

<Attributes>
  <Attribute
    name="data"
    type="SourceWorkflowTrigger"
    description="The associated source workflow trigger"
    typeSlug="/integrations/sources/overview#events"
  />
</Attributes>

### `source_workflow_trigger.committed`

Occurs whenever a source workflow trigger is committed to the environment.
