---
title: API Keys
description: Understand how to use public and secret API keys to authenticate requests to Knock's API, including key management and security best practices.
