...
```
  ...
  <Accordion title="Working with preferences" anchorSlug="working-with-preferences">
    **Old SDK:**
...
```
  ...
  <Accordion title="Working with tenants" anchorSlug="working-with-tenants">
    **Old SDK:**
...
If you run into any issues during your migration, reach out to our [support team](mailto:support@knock.app) or open an issue on <a href="https://github.com/knocklabs/knock-python/issues" target="_blank" rel="noopener">GitHub</a>.
