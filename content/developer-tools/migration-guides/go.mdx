...
<AccordionGroup>
  <Accordion title="Triggering workflows" anchorSlug="triggering-workflows">
    **Old SDK:**
...
```
  ...
  <Accordion title="Identifying users" anchorSlug="identifying-users">
  **Old SDK:**
...
```
  ...
  <Accordion title="Working with objects" anchorSlug="working-with-objects">
**Old SDK:**
...
If you run into any issues during your migration, reach out to our [support team](mailto:support@knock.app) or open an issue on <a href="https://github.com/knocklabs/knock-go/issues" target="_blank" rel="noopener">GitHub</a>.
