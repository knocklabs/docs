...
description: Generate and manage service tokens to authenticate requests to Knock's management API and CLI, including token permissions and security best practices.
