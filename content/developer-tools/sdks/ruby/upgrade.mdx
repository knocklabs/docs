...
# or using environment variable KNOCK_API_KEY
```
...
1. **Strong Typing with Sorbet**: Improved type definitions for better IDE integration
   ...
   ```ruby
   # Enable Sorbet type checking for better development experience
   ```
