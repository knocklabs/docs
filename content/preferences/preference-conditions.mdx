...
To set preference conditions for a user, include a `conditions` array when you update the user's `PreferenceSet`. Conditions use the same preferences APIs as channel, category, and workflow preferences.
