...
<AccordionGroup>
  <Accordion title="Standard preference merge hierarchy" anchorSlug="standard-preference-merge-hierarchy">
...
<AccordionGroup>
  <Accordion title="General preference rules" anchorSlug="general-preference-rules">
  ...
  <Accordion title="Resolving preference conflicts" anchorSlug="resolving-preference-conflicts">
  ...
  <Accordion title="Debugging preferences" anchorSlug="debugging-preferences">
...
<AccordionGroup>
  <Accordion title="Can I update a single preference rather than replacing a recipient's entire preference set?" anchorSlug="faq-update-single-preference">
  ...
  <Accordion title="What is the merge strategy, and how can I use it to override the merge hierarchy?" anchorSlug="faq-preference-merge-strategy">
  ...
  <Accordion title="Why do I see 'channel types' preferences in the workflow debugger even though I didn't set them?" anchorSlug="faq-channel-type-preferences-in-debugger">
  ...
  <Accordion title="What's the difference between channel preferences and channel type preferences?" anchorSlug="faq-channel-vs-channel-type-preferences">
