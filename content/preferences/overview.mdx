---
title: Preferences
description: "Build and implement notification preferences in Knock, including preference center setup, user preference management, and advanced features like bulk operations."
