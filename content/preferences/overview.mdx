...
A preference center is a place where users can manage their notification preferences. For a no-code option, use the [hosted preference center](/preferences/hosted-preference-center). To build and host your own UI, see [Build your preference center](/preferences/build-your-preference-center).
