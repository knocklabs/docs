...
<Callout
  ...
  text={
    <>
      ...
      need to support <a href="/multi-tenancy/per-tenant-preferences">
...
/>
  ...
  <Step title="Set a user's preferences">
    ...
    By default, the `set` method will overwrite any existing `PreferenceSet` with the new preferences provided. You can learn more about how to update a single preference in the [frequently asked questions](#frequently-asked-questions) section below.
