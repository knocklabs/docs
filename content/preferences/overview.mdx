...
The following hierarchies are used when merging preferences. Each item in the list takes precedence over the ones that follow.

<AccordionGroup>
  <Accordion title="When no tenant is applied to the workflow trigger" defaultOpen={true}>
