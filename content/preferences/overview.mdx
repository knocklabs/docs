...
<AccordionGroup>
  <Accordion title="General preference rules">
    ...
    - A recipient's preferences will be merged against the default PreferenceSet within a given environment, with recipient-level preferences taking precedence in the merge.
  </Accordion>
