...
- Send window preferences. If you want to enable your users to configure when they should receive notifications from your application, you can programmatically set their send window preferences.
