...
<Callout
  type="info"
  title="Unsubscribe links are separate from preference center custom domains."
  text={
    <>
      Preference center{" "}
      <a href="/manage-your-account/custom-domains">custom domains</a> apply to{" "}
      <code>vars.manage_preferences_url</code> links only. They do not affect{" "}
      <code>vars.commercial_unsubscribe_url</code>.
    </>
  }
/>
...
To learn more about managing recipient preferences and building preference centers with Knock, visit our [preferences overview](/preferences/overview) or see [Choosing a preference center](/preferences/overview#choosing-a-preference-center).
