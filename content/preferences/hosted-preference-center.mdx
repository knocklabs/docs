...
Knock's hosted preference center is a page where your users manage their notification preferences. You configure it in your dashboard and Knock hosts and renders the page, so you can launch a preference center without building or hosting any UI yourself.
