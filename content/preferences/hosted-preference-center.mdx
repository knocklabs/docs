...
You can also [generate the same signed URL and token on demand](/preferences/build-your-preference-center) from your server using Knock's token based preferences APIs, for example when linking to preferences from your application rather than a notification template.
