...
Knock's hosted preference center is a page where your users manage their notification preferences. You configure it from the dashboard; Knock hosts and renders the page, so you can launch a preference center without building or hosting any UI yourself.
...
<Callout
  ...
  text={
    <>
      ...
      <a href="/concepts/tenants">tenants</a>.
    </>
  }
/>
...
<Steps titleSize="h3">
  ...
  <Step title="Preview as a user">
    Before you save, you can preview the preference center as a specific user. This renders that user's page exactly as they would see it with their current preferences and your latest configuration, so you can confirm the experience before it goes live.
  </Step>
