...
For in-app channels, messages can be updated indefinitely via this operation. For all other channel types, messages outside the account retention window will not be updated as part of this operation.
