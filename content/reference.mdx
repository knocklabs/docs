...
- `200` When authentication is valid.
- `403` When authentication is invalid.
...
{
  "code": "authorization",
  "message": "Microsoft Teams authentication is invalid.",
  "status": 403,
  "type": "authentication_error"
}
```
...
<ContentColumn>
Get a list of teams belonging to the Microsoft Teams tenant.
...
<Attributes>
  ...
  <Attribute
    name="query_options"
    type="string"
    description="Query options used with the Microsoft Graph API for pagination and filtering."
  />
</Attributes>

### Returns

- `200` List of teams in the Microsoft Teams tenant.
  ...
  "ms_teams_teams": [
    {
      ...
      "description": "Team for engineering discussions"
    }
  ],
...
<ContentColumn>
Get a list of channels within a Microsoft Teams team. By default, archived and private channels are excluded from the results.
...
- `200` List of channels in the specified team.
- `403` When no Microsoft Entra tenant ID is set for the given object.
  ...
  "ms_teams_channels": [
    {
      ...
      "isArchived": false,
      "createdDateTime": "2024-01-14T20:30:24Z"
    }
  ]
}
```
