...
The preference set `:id` can be either `"default"` or a `tenant.id`. Learn more about per-tenant preference sets in [our preferences guide](/concepts/preferences#recipient-preference-sets).
