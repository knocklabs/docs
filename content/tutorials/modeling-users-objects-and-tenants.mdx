...
Tenants are also useful for helping you [scope the in-app feed](/multi-tenancy/scoping-in-app-feeds) to messages about a certain workspace or organization.
