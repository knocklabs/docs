...
<Steps titleSize="h3">
  ...
  <Step title="Create workflows">
    ...
    **Prompt:**
    ...
    4. Create an email step in the workflow with:
      ...
      - The template-specific content from the analysis
    5. Use any partials that were identified for this template in the analysis, referencing them with correct keys
  ...
  <Step title="Verify the migration">
    ...
    **Prompt:**
    ...
    4. **Preview templates**: For each workflow created, preview the email step with sample data and compare it to the original template to verify pixel-perfect reproduction. Use the variable mappings from the analysis to create appropriate test data. Any dynamic variables in the original templates should also be replaced with the test data for the comparison.
