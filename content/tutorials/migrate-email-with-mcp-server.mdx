...
<Steps titleSize="h3">
  ...
  <Step title="Verify the migration">
    ...
    **Prompt:**
    ...
    4. **Preview templates**: For each workflow created, preview the email step with sample data and compare it to the original template to verify pixel-perfect reproduction. Use the variable mappings from the analysis to create appropriate test data.
