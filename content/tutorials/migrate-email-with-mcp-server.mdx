...
To complete the steps in this tutorial, we recommend the following permissions:

- Manage resources
- Commits
- Manage data (only required for creating test users)
- Documentation

For thorough testing, you'll likely want to grant debug permissions as well.

<br />
<figure>
  <Image
    src="/images/tutorials/email-migration/mcp-permissions.png"
    alt="A screenshot of the MCP permissions page in the Knock dashboard"
    width={400}
    height={600}
    className="rounded-md mx-auto border border-gray-200"
  />
  <figcaption>Recommended MCP permissions in the Knock dashboard</figcaption>
</figure>
