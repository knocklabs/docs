...
- **User preferences.** In order to power [user preferences](/preferences/overview) in Knock, you need to [build a preference center](/preferences/build-your-preference-center) in your application that gives your user control over the types of notifications they receive. For a no-code alternative, see the [hosted preference center](/preferences/hosted-preference-center).
