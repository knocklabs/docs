...
<Steps titleSize="h3">
  <Step title="Channels">
    ...
    Channels are configured under the **Channels and sources** tab in your dashboard account settings. You can see a full list of supported channel types and providers [here](/integrations/overview).
