...
<AccordionGroup>
  <Accordion
    title="Can I use FCM web push messages with any browser?"
    anchorSlug="faq-fcm-web-push-browser-support"
  >
    Yes, FCM web push is supported in all major modern browsers.
  </Accordion>
  <Accordion
    title="Why do I see a 'site updated in the background' notification?"
    anchorSlug="faq-site-updated-in-background-notification"
  >
