...
If you're migrating your local partial files into Knock, you can arrange them using the example file structure above and then push them into Knock with a single command using [`knock partial push --all`](/cli/partial/push). Each `partial.json` file should follow the structure defined [here](/mapi-reference/partials/schemas/partial).
...
If you're migrating your local guide files into Knock, you can arrange them using the example file structure above and then push them into Knock with a single command using [`knock guide push --all`](/cli/guide/push). Each `guide.json` file should follow the structure defined [here](/mapi-reference/guides/schemas/guide).
...
If you're migrating your local message type files into Knock, you can arrange them using the example file structure above. Each `message_type.json` file should follow the structure defined [here](/mapi-reference/message_types/schemas/message_type).
