...
If you're migrating your local translation files into Knock, you can arrange them using the file structure above and then push them into Knock with a single command using [`knock translation push --all`](/cli/translation/push). Each `<locale>.json` or `<namespace>.<locale>.json` file should follow the structure defined [here](https://schemas.knock.app/cli/translation.json).
...
If you're migrating your local partial files into Knock, you can arrange them using the example file structure above and then push them into Knock with a single command using [`knock partial push --all`](/cli/partial/push). Each `partial.json` file should follow the structure defined [here](https://schemas.knock.app/cli/partial.json).
...
If you're migrating your local guide files into Knock, you can arrange them using the example file structure above and then push them into Knock with a single command using [`knock guide push --all`](/cli/guide/push). Each `guide.json` file should follow the structure defined [here](https://schemas.knock.app/cli/guide.json).
...
If you're migrating your local message type files into Knock, you can arrange them using the example file structure above. Each `message_type.json` file should follow the structure defined [here](https://schemas.knock.app/cli/message_type.json).
