...
<Attributes>
  ...
  <Attribute
    name="--template"
    type="string"
    description="A template to use for scaffolding the workflow. Accepts a template string that resolves to a GitHub repository URL. For example, 'knocklabs/templates/workflows/digest-email' resolves to 'https://github.com/knocklabs/templates/tree/main/workflows/digest-email'. You can use your own organization and repository (e.g., 'your-org/your-repo/workflows/my-workflow')."
  />
  <Attribute
    name="--push"
    type="boolean"
...
```bash title="Create a workflow from a Knock template"
knock workflow new --key=my-workflow --template=knocklabs/templates/workflows/digest-email
```

```bash title="Create a workflow from a custom template repository"
knock workflow new --key=my-workflow --template=your-org/your-repo/workflows/my-workflow
```
