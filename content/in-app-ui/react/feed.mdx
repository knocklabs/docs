...
[See a live demo of our pre-built in-app feed UI element ->](https://knock-in-app-notifications-react.vercel.app/)
...
You can use our hooks to build headless notifications UI on top of. [Learn more](/in-app-ui/react/custom-notifications-ui).
