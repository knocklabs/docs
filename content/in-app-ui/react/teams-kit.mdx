...
To get started you'll need a <a href="https://dashboard.knock.app" target="_blank" rel="noopener">Knock account</a>, a [Microsoft Teams channel connected to a Microsoft Teams bot](/integrations/chat/microsoft-teams/overview), a [Graph API-enabled application](/integrations/chat/microsoft-teams/overview#configuring-a-graph-api-enabled-application-in-microsoft-entra), and a workflow with a Microsoft Teams channel step.
