...
<Callout
  ...
  text={
    <>
      ...
      instructions to your app administrators to{" "}
      <a
...
If you need custom designs or want to display additional information around your Microsoft Teams integration, you do not need to use Knock's pre-built components to take advantage of TeamsKit.
...
If you want more fine-grained control of your data, you can skip the hooks and use the functions Knock exposes in the [`@knocklabs/client` library](https://github.com/knocklabs/javascript/tree/main/packages/client)—as long as you wrap the component you are calling it in inside of `KnockProvider`. You can accomplish anything we provide with hooks or the components with the following functions:
