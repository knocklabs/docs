...
<Callout
  ...
  text={
    <>
      In-app messaging and message types are currently in beta. If you'd like early access, or this is
...
const MyApp = () => {
  return (
    <KnockProvider publicKey={process.env.KNOCK_PUBLICK_KEY} userId={currentUser.id}>
