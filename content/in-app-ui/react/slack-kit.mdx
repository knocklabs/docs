...
To get started you'll need a <a href="https://dashboard.knock.app" target="_blank" rel="noopener">Knock account</a>, a [Slack channel connected to a Slack app](/in-app-ui/react/slack-kit), and a workflow with a Slack channel step.
