...
To use this example, you'll need <a href="https://dashboard.knock.app" target="_blank" rel="noopener">an account on Knock</a> and an [identified user](/concepts/users). You'll also need:
