...
<Callout
  type="info"
  title="Authenticate with a public API key."
  text={
    <>
      Custom preference centers authenticate with your public API key and a
      signed user token from your backend. You don't need a secret API key in
      the browser. See{" "}
