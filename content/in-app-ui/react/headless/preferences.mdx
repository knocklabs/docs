...
const CategoryPreferences = () => {
  ...
  const handleCategoryChannelToggle = (categoryKey, channelType, enabled) => {
    const currentCategory = preferences?.categories?.[categoryKey] || { channel_types: {} };
              ...
              <div key={channelType} className="channel-preference">
                <label>
                  <input
                    ...
                    checked={enabled}
                    onChange={(e) => 
                      handleCategoryChannelToggle(categoryKey, channelType, e.target.checked)
                    }
                  />
                  {channelType} notifications
                </label>
