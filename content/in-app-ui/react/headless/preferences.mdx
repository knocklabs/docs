...
This page is a React-specific implementation of [Build your preference center](/preferences/build-your-preference-center). The usePreferences hook wraps the same preferences APIs documented on the build page. It uses public API key authentication, a signed user token, and user.getPreferences() / user.setPreferences() under the hood.
...
- [Choosing a preference center](/preferences/overview#choosing-a-preference-center)
