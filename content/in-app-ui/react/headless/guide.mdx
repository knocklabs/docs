...
<Steps titleSize="h2">
  ...
  <Step title="Setup the KnockGuideProvider within your product.">
    ...
    ```
    Also, if you are using Next.js or Tanstack Router, consider using the [KnockGuideLocationSensor](/in-app-ui/react/sdk/components/knock-guide-location-sensor) helper component inside `KnockGuideProvider` to facilitate evalutating activation rules based on route changes.
