...
Our <a href="https://github.com/knocklabs/javascript/tree/main/examples/expo-example" target="_blank" rel="noopener">Expo SDK example app</a> shows patterns for handling push token registration, building an in-app feed, and managing user notification preferences.
