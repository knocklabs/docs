...
A message type represents a type of message you map to a UI component/element within your application to show to your users. Message types work with [guides](/concepts/guides) to render non-feed messages within your application.

Once a message type exists, you can use it to create [guides](/concepts/guides).
...
- **A schema.** A schema defines the fields a message type will have in the template editor and forms the structure of the message contents returned by the [guides API](/api-reference/guides/).
