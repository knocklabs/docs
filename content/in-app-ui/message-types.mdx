...
<AccordionGroup>
  <Accordion title="Text" anchorSlug="text">
...
```
  ...
  <Accordion title="Markdown" anchorSlug="markdown">
...
```
  ...
  <Accordion title="Textarea" anchorSlug="textarea">
...
```
  ...
  <Accordion title="Boolean" anchorSlug="boolean">
...
```
  ...
  <Accordion title="Select" anchorSlug="select">
  ...
  <Accordion title="Multi-select" anchorSlug="multi-select">
  ...
  <Accordion title="Button" anchorSlug="button">
  ...
  <Accordion title="URL" anchorSlug="url">
    **Settings**
  ...
  <Accordion title="Image" anchorSlug="image">
