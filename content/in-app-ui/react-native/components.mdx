...
description: "Build cross-platform notification interfaces with Knock's pre-built React Native components, including NotificationFeed and NotificationIconButton for consistent mobile experiences."
