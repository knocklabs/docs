...
<Callout emoji="ℹ️" 
  text={
    <>
      <strong>Migration note.</strong> The <code>NotificationFeedContainer</code> component is deprecated and has been replaced with <code>NotificationFeed</code>. The container component will be removed in a future release.
    </>
  }
/>
