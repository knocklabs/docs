...
The following example demonstrates how to create your own container component to wrap the NotificationFeed with custom styling and behavior, such as a header with a close button:
