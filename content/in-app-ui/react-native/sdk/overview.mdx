...
<Callout
  ...
  text={
    <>
      ...
      <a href="/in-app-ui/expo/sdk/overview">Expo SDK</a>. Our React Native SDK
      is meant for use with React Native apps that are not built with a
      framework such as Expo.
    </>
  }
/>
