...
Message types are versioned at the environment level as a versioable resource, but are not promotable like other resources in Knock.
...
See the [API reference](/mapi-reference/message_types/schemas/message_type) for more information.
