...
The `initialize` method optionally takes a `FeedClientOptions` object that can contain any of the properties accepted by the [user feed API endpoint](https://docs.knock.app/reference#query-parameters-5).
