...
`SwipeConfig` allows for UI customization of the left and right swipe actions of the FeedNoticationRow.
...
<Attributes>
  ...
  <Attribute
    ...
    description="The textStyle of the title."
  />
  <Attribute name="imageId" type="Int?" description="The image resourse." />
  <Attribute
    name="inverseImageId"
    type="Int?"
    description="The inverse image resourse."
  />
  <Attribute
    name="imageSize"
    type="Int?"
