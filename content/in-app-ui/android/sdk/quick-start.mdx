...
<ul>
  <li data-link-list>
    <a href="https://dashboard.knock.app/signup" target="_blank" rel="noopener">
      A Knock account
    </a>
  </li>
  <li>
  ...
  <li>
    An in-app feed channel with a workflow that produces in-app feed messages
    (optional)
  </li>
  <li>
    A Firebase Cloud Messaging channel with a workflow that produces push
...
See <a href="https://github.com/knocklabs/knock-android" target="_blank" rel="noopener">here</a> for more information on installation.
