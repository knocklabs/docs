...
In this section, you'll find the documentation for the classes and methods available in the <a href="https://github.com/knocklabs/knock-android" target="_blank" rel="noopener">Android SDK</a>.
...
You can learn more about FCM <a href="https://firebase.google.com/docs/cloud-messaging/android/client" target="_blank" rel="noopener">here</a>.
