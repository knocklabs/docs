...
- Review Firebase's <a href="https://firebase.google.com/docs/cloud-messaging" target="_blank" rel="noopener">documentation</a> for advanced features and updated practices.

## 1. Create a Firebase project

- **Go to the <a href="https://console.firebase.google.com/" target="_blank" rel="noopener">Firebase Console</a>.**
