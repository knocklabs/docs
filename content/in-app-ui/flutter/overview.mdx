---
title: "Building in-app UI in Flutter"
description: Learn more about the in-app notifications experiences you can build in Flutter applications with Knock.
...
- [Full reference](/in-app-ui/flutter/reference)
- [Github repository](https://github.com/knocklabs/knock-flutter)

Using the Flutter SDK it's possible to:

- Integrate push notifications
- Build in-app experiences, like [feeds](/in-app-ui/flutter/notification-feeds) that update in real-time
