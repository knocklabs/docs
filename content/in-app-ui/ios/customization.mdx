...
<Attributes>
  ...
  />
  <Attribute
    name="swipeRightConfig"
    type="SwipeButtonConfig?"
    description="Set this to nil to remove the right swipe action."
  />
  <Attribute
    name="swipeLeftConfig"
    type="SwipeButtonConfig?"
    description="Set this to nil to remove the left swipe action."
  />
  <Attribute
