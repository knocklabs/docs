...
<Callout
  type="warning"
  title="Initializing the Feed."
  text={
    <>
      Please remember that you will still need to initialize the{" "}
      <code>feedManager</code> manually before displaying this component. Check
      out our{" "}
      <a href="/in-app-ui/ios/sdk/reference#feedmanager">
