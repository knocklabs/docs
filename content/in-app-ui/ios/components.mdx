...
<Callout
  ...
  text={
    <>
      ...
      that you will still need to initialize the <code>feedManager</code> manually before
      displaying this component. Check out our{" "}
      <a href="/sdks/ios/reference#feedmanager">
        FeedManager documentation for more information.
      </a>{" "}
      See below for an example of how to initialize the feedmanager.
    </>
  }
/>
