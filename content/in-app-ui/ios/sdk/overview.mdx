...
You can find a complete iOS example application that uses the Swift SDK <a href="https://github.com/knocklabs/ios-example-app" target="_blank" rel="noopener">here</a>. The app shows patterns for handling push token registration, building an in-app feed using SwiftUI, and managing user notification preferences.
...
All contributors are welcome, from casual to regular. Feel free to open a <a href="https://github.com/knocklabs/knock-swift/pulls/new" target="_blank" rel="noopener">pull request</a>.
