...
<Steps titleSize="h3">
  ...
  <Step title="Handle incoming URLs from a push notification">
    ...
    <AccordionGroup>
      <Accordion title="Handle a push notification being tapped while the app is closed" anchorSlug="push-notification-tapped-app-closed">
        ...
        <Accordion title="Handle a push notification being tapped while the app is in the foreground or background" anchorSlug="push-notification-tapped-foreground-background">
