...
1. **CSS variables**: The feed uses CSS variables that you can override to align with your product's design. All variables are prefixed with `--rnf-`. You can find the complete list of available variables in the <a href="https://github.com/knocklabs/javascript/blob/main/packages/react/src/theme.css" target="_blank" rel="noopener">theme.css source code</a>.

2. **Custom CSS**: You can completely replace Knock's CSS to tailor the feed's look. All feed classes are unique and start with `rnf-`. View the <a href="https://github.com/knocklabs/javascript/tree/main/packages/react/src" target="_blank" rel="noopener">component source code</a> for class details.
