...
<Callout
  ...
  text={
    <>
      We're working on adding guides support to more of our client SDKs. Please reach out to us at{" "}
      <a href="mailto:support@knock.app?subject=Guides%20request">support@knock.app</a> if lack of support in a specific SDK is preventing you from adopting guides.
...
<AccordionGroup>
  <Accordion title="Question"></Accordion>
</AccordionGroup>
