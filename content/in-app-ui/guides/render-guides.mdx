...
As well as the [guides API](/api-reference/users/guides/), Knock exposes a set of client SDKs that you can use to render guides in your product. The Kmock client SDKs provide helpers and logic for making working with guides in your product easier.
...
We'll soon be adding support for more of our client SDKs. Please reach out to our team if there's a specific SDK that's preventing you from adopting guides.
