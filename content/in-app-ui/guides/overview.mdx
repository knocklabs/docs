...
<AccordionGroup>
  <Accordion title="How does pricing for Guides work?" anchorSlug="faq-guides-pricing">
  ...
  <Accordion title="I'm already an Enterprise customer. Do I need to pay for guides separately?" anchorSlug="faq-guides-pricing-for-enterprise">
  ...
  <Accordion title="Can I use guides in my cross-channel workflows and broadcasts?" anchorSlug="faq-guides-in-workflows-and-broadcasts">
    Users are made eligible for guides based on their
    [audience](/concepts/audiences) membership and [targeting
    rules](/in-app-ui/guides/create-guides#targeting). The most direct way to
    influence guide eligibility from a workflow or broadcast is to add a
    [in-app guide step](/designing-workflows/in-app-guide-step), which enrolls
    the recipient into the guide's targeting the moment the step runs.

    Alternatively, use the [update audience function](/designing-workflows/update-audience-function) to add a user to a
    ...
    criteria of a certain guide.

  </Accordion>
  <Accordion title="Is guide eligibility recalculated in real-time?" anchorSlug="faq-real-time-guide-eligibility">
  ...
  <Accordion title="Can I pass application state to guides to use in targeting and personalization?" anchorSlug="faq-application-state-in-guide-targeting">
  ...
  <Accordion title="Can I power multi-step product tours with guides?" anchorSlug="faq-multi-step-product-tours">
