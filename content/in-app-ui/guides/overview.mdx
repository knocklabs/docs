...
<AccordionGroup>
  <Accordion title="How does pricing for Guides work?">
    ...
    [support@knock.app](mailto:support@knock.app?subject=Guides%20pricing).
  </Accordion>
  <Accordion title="Can I use guides in my cross-channel workflows and broadcasts?">
    ...
    your use case at
    [support@knock.app](mailto:support@knock.app?subject=Guides%20feedback).
  </Accordion>
  ...
  <Accordion title="Can I power multi-step product tours with guides?">
    We're working on this and if you're interested we'd love to hear your use
    case at
    [support@knock.app](mailto:support@knock.app?subject=Guides%20feedback).
  </Accordion>
</AccordionGroup>
