...
1. Navigate to the **Guides** page in your Knock dashboard sidebar.
2. Click on the "Edit order" button in the top right corner.
3. While in "Edit order" mode, drag and drop guides to re-order them. Guides positioned higher on the page will be prioritized over guides below it.
4. Click the "Save order" button to apply the new order.
...
1. Navigate to the **Guides** page in your Knock dashboard sidebar.
2. Click on the "Throttle: .." button in the top right corner to open the throttle settings modal.
3. Set a display interval by its value and unit. Clear out the inputs to unset it.
4. Click the "Save changes" button to apply the new throttle settings.
...
### Opting guides out of throttling
