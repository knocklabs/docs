...
You can access guide analytics programmatically using the [Guides API](/api-reference/users/guides). This enables you to work with guide message data and gives you flexibility to build custom dashboards and integrate guide metrics into your existing analytics tools.
...
<AccordionGroup>
  <Accordion title="How long are guide analytics retained?">
    Guide analytics are subject to your account's [data retention policy](/manage-your-account/data-retention).
  </Accordion>

<Accordion title="Can I export guide analytics data?">
  Yes, you can access guide analytics via the Knock API or in the messages table available via [data warehouse sync](/integrations/extensions/data-sync).
</Accordion>
</AccordionGroup>
