...
- **Guides are version controlled.** Just like workflows, guides follow our [versioning model](/version-control/commits). By default, changes are made in your development environment and promoted to production. If your account has [production write access](/version-control/environments#production-write-access) enabled, you can create and edit guides directly in the production environment.
