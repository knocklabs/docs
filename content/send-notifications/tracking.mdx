...
<Callout
  emoji="💡"
  title="Provider-owned tracking."
  text={
    <>
      Many of the providers Knock integrates with offer their own versions of
      open and link tracking. You can configure your channels to use
      provider-owned tracking in these cases. We recommend using either
      provider-owned tracking <i>or</i> Knock tracking.
    </>
  }
/>
...
<Callout
  emoji="🌠"
  title="In-app feed channels have open tracking by default."
  text={
    <>
