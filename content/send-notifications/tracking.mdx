...
You can also configure custom tracking domains for your account to use for link tracking, short links in SMS and WhatsApp, and email open tracking. See the [custom domains documentation](/manage-your-account/custom-domains) for more details.
