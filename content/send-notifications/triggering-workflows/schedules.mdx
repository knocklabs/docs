...
You can see all scheduled workflows under the "Schedules" section of the workflow. Please note: schedules will not display if there are no schedules setup for any recipients.
