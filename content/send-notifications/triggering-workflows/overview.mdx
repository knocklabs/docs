...
description: Learn how to trigger cross-channel notification workflows in Knock.
tags: ["trigger", "notify", "data", "actor"]
section: Send notifications
---

Knock executes workflow runs for specified recipients when workflows are triggered. Workflows can be triggered in these ways:
...
Triggering a workflow may not always result in sent messages. Recipients can opt out of notifications through their `preferences`. Knock handles all [preference-based opt-outs](/preferences/overview) automatically.
