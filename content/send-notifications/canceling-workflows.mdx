...
- [Wait for event functions](/send-notifications/designing-workflows/wait-for-event-function) will pause workflows until a matching source event is received or the wait time expires.
