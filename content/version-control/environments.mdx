...
In some cases, you may want to enable non-technical team members to manage content directly in production. For example, a marketer who wants to create content directly in production. You can enable production write access in your account to support this.
...
To enable production write access, navigate to the **Permissions** page under the **Admin** section of your account settings.
