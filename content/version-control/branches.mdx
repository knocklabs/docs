...
## Recipients and audiences on branches
...
Similarly, branches share audience membership with the main branch: if a user is added to an audience on the main branch, they will be added to the same audience on all branches.
