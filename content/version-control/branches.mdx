...
Branches in Knock are a way to isolate changes to your Knock resources. They're like sandboxes for your changes, allowing you to make changes to your resources without affecting the `main` branch (your `development` environment), or other branches in your account.
...
- Audiences cannot be created or updated on a branch.
