...
<Attributes>
  <Attribute
    name="--environment"
    type="string"
    description="The environment to validate the audience against. Defaults to development."
  />
  <Attribute
    name="--branch"
    type="string"
...
<Section title="knock audience new [flags]" path="/audience/new">
<ContentColumn>

Create a new audience with a minimal configuration. The command creates a new audience directory in your local file system. By default, this will be in the audiences resource directory set by your `knock.json` file, or the current working directory if not configured.
...
<Attributes>
  <Attribute
    name="--name"
    type="string"
    description="The name of the audience. If not provided, will be generated from the key."
  />
  <Attribute
    name="--key"
    type="string"
    description="The key of the audience. If not provided, will be prompted or inferred from the directory name."
  />
  <Attribute
    name="--type"
    type="string"
    description="The type of the audience. One of: `static`, `dynamic`. Note: dynamic is in beta and requires access."
  />
  <Attribute
    name="--description"
    type="string"
  ...
  <Attribute
    name="--environment"
    type="string"
    description="The environment to create the audience in. Defaults to development."
  />
  <Attribute
    name="--branch"
    type="string"
  ...
  <Attribute
    name="--push"
    type="boolean"
    description="Push the audience to Knock after creating it locally. Defaults to false."
  />
  <Attribute
    name="--force"
    type="boolean"
    description="Force creation of the audience directory without confirmation. Defaults to false."
  />
</Attributes>
...
```bash title="Create an audience interactively"
knock audience new
```

```bash title="Create a static audience"
knock audience new --key=new-signups --name="New signups" --type=static
```

```bash title="Create and push an audience"
knock audience new --key=new-signups --type=static --push
```

</ExampleColumn>
</Section>

<Section title="knock audience open <audience_key> [flags]" path="/audience/open">
<ContentColumn>

Open an audience in the Knock dashboard. This command opens the audience page in your default browser.
...
```bash title="Basic usage"
knock audience open new-signups
```

```bash title="Open an audience in a different environment"
knock audience open new-signups --environment=production
```
