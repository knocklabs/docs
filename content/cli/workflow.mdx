...
<Section title="knock workflow open <workflow_key> [flags]" path="/workflow/open">
<ContentColumn>

Open a workflow in the Knock dashboard. This command opens the workflow page in your default browser.
...
```bash title="Basic usage"
knock workflow open my-workflow
```

```bash title="Open a workflow in a different environment"
knock workflow open my-workflow --environment=production
```
