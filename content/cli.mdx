...
<Section title="Guide file structure" path="/guides/file-structure">
<ContentColumn>
...
If you're migrating your local guide files into Knock, you can arrange them using the example file structure above and then push them into Knock with a single command using [`knock guide push --all`](/cli/guides/push).

</ContentColumn>
</Section>

<Section title="knock guide list [flags]" path="/guides/list">
<ContentColumn>
...
<Section title="knock guide get [flags]" path="/guides/get">
<ContentColumn>
...
<Section title="knock guide pull [flags]" path="/guides/pull">
<ContentColumn>
...
See the [Guide file structure](/cli/guides/file-structure) section for details on how guide files are organized.
...
<Section title="knock guide push [flags]" path="/guides/push">
<ContentColumn>
...
<Section title="knock guide validate [flags]" path="/guides/validate">
<ContentColumn>
...
<Section title="knock guide activate [flags]" path="/guides/activate">
<ContentColumn>
...
<Section title="Message type file structure" path="/message-types/file-structure">
<ContentColumn>
