...
<Section title="knock workflow new [workflow_key] [flags]" path="/workflow/new">
<ContentColumn>
...
knock workflow new my-workflow
```

```bash title="Create a workflow with specific steps"
knock workflow new my-workflow --steps=email,sms,in_app_feed
```

```bash title="Create a workflow from a template"
knock workflow new my-workflow --template=workflows/digest-email
```

```bash title="Create and push a workflow"
knock workflow new my-workflow --steps=email --push
```
...
<Section title="knock layout new [layout_key] [flags]" path="/email-layout/new">
<ContentColumn>
...
knock layout new my-layout --push
```
...
<Section title="knock partial new [partial_key] [flags]" path="/partial/new">
<ContentColumn>
...
knock partial new my-partial
```

```bash title="Create an HTML partial"
knock partial new my-partial --type=html
```

```bash title="Create and push a partial"
knock partial new my-partial --type=markdown --push
```
...
<Section title="knock guide new [guide_key] [flags]" path="/guide/new">
<ContentColumn>
...
knock guide new my-guide
```

```bash title="Create a guide with a message type"
knock guide new my-guide --message-type=banner
```

```bash title="Create and push a guide"
knock guide new my-guide --message-type=modal --push
```
...
<Section title="knock message-type new [message_type_key] [flags]" path="/message-type/new">
<ContentColumn>
...
knock message-type new my-message-type
```
...
knock message-type new my-message-type --push
```
