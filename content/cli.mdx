...
Branches are a way to isolate changes to your Knock resources. It's like a sandbox for your changes, allowing you to make changes to your resources without affecting the main branch, or other branches in your account.

[Learn more about branches →](/version-control/branches)
...
<Section title="knock branch create <branch_name>" path="/branch/create">
<ContentColumn>
...
<Section title="knock branch delete <branch_name>" path="/branch/delete">
<ContentColumn>
...
<Callout
  ...
  text={
    <>
      Deleting a branch is a permanent operation and cannot be undone.
    </>
  }
/>
</ContentColumn>
...
<Section title="knock branch switch <branch_name>" path="/branch/switch">
<ContentColumn>
