...
```javascript title="Set your alert object"
...
```javascript title="Add subscribers to your alert"
...
```javascript title="Trigger workflow with alert recipient"
...
```javascript title="Trigger an alert without using Knock objects"
await knock.workflows.trigger("alert", {
  data: {
