...
/**
 * Client component for rendering API method details.
 *
 * This handles the interactive elements like expandable response properties.
 */
...
export function ApiReferenceMethodClient({
  methodName,
  methodType,
  endpoint,
  path,
  ...
  const responseSchemas: OpenAPIV3.SchemaObject[] = resolveResponseSchemas(method);
